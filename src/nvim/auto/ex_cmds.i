# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
...
# 66 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c" 2



# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.h" 1
# 70 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c" 2
...
static int sort_compare(const void *s1, const void *s2)
{
  ...
  if (sort_nr)
    ...
    __builtin___strncpy_chk ((char *)(sortbuf1), (char *)(ml_get(l1.lnum) + l1.start_col_nr), (size_t)(l1.end_col_nr - l1.start_col_nr + 1), __builtin_object_size ((char *)(sortbuf1), 2 > 1 ? 1 : 0));

    sortbuf1[l1.end_col_nr - l1.start_col_nr] = 0;
    __builtin___strncpy_chk ((char *)(sortbuf2), (char *)(ml_get(l2.lnum) + l2.start_col_nr), (size_t)(l2.end_col_nr - l2.start_col_nr + 1), __builtin_object_size ((char *)(sortbuf2), 2 > 1 ? 1 : 0));
...
void do_bang(int addr_count, exarg_T *eap, int forceit, int do_in, int do_out)
{
  ...
  do {
    ...
    *t = '\000';
    if (newcmd != ((void*)0))
      __builtin___strcat_chk ((char *)(t), (char *)(newcmd), __builtin_object_size ((char *)(t), 2 > 1 ? 1 : 0));
    if (ins_prevcmd)
      __builtin___strcat_chk ((char *)(t), (char *)(prevcmd), __builtin_object_size ((char *)(t), 2 > 1 ? 1 : 0));
    p = t + strlen((char *)(t));
    __builtin___strcat_chk ((char *)(t), (char *)(trailarg), __builtin_object_size ((char *)(t), 2 > 1 ? 1 : 0));
    xfree(newcmd);
    newcmd = t;
  ...
  if (*p_shq != '\000') {
    ...
    __builtin___strcpy_chk ((char *)(newcmd), (char *)(p_shq), __builtin_object_size ((char *)(newcmd), 2 > 1 ? 1 : 0));
    __builtin___strcat_chk ((char *)(newcmd), (char *)(prevcmd), __builtin_object_size ((char *)(newcmd), 2 > 1 ? 1 : 0));
    __builtin___strcat_chk ((char *)(newcmd), (char *)(p_shq), __builtin_object_size ((char *)(newcmd), 2 > 1 ? 1 : 0));
    free_newcmd = 1;
  }
  if (addr_count == 0) {
...
# 1019 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
  ...
  if (itmp != ((void*)0) && buf_write(curbuf, itmp, ((void*)0), line1, line2, eap,
    ...
    --no_wait_return;
    if (!aborting())
      (void)emsg2((char_u *)(libintl_gettext((char *)(e_notcreate))), (char_u *)(itmp));
    goto filterend;
  }
...
# 1095 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
  ...
  if (do_out) {
    if (otmp != ((void*)0)) {
      if (readfile(otmp, ((void*)0), line2, (linenr_T)0, (linenr_T)0x7fffffff,
              eap, 0x02) == 0) {
        if (!aborting()) {
          msg_putchar('\n');
          emsg2((char_u *)(libintl_gettext((char *)(e_notread))), (char_u *)(otmp));
        }
        goto error;
      }
      if (curbuf != old_curbuf)
      ...
      if (cmdmod.keepmarks || vim_strchr(p_cpo, 'R') == ((void*)0)) {
        if (read_linecount >= linecount)
          ...
          mark_adjust(line1, line1 + read_linecount - 1,
              linecount, 0L);
          mark_adjust(line1 + read_linecount, line2, 0x7fffffff, 0L);
        }
      }
...
)
{
  ...
  if (p_warn
    ...
    for (buf_T *buf = firstbuf; buf != ((void*)0); buf = buf->b_next) {
      if (bufIsChanged(buf)) {
        msg_puts((char_u *)(libintl_gettext((char *)("[No write since last change]\n"))));
        break;
      }
    }
...
# 1296 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
char_u *make_filter_cmd(char_u *cmd, char_u *itmp, char_u *otmp)
{
  ...
  if (itmp != ((void*)0) || otmp != ((void*)0)) {
    ...
    __builtin___strcpy_chk ((char *)(buf), (char *)(cmd), __builtin_object_size ((char *)(buf), 2 > 1 ? 1 : 0));
  }
...
# 1357 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
  if (otmp != ((void*)0))
    append_redir(buf, (int)len, p_srr, otmp);

  return buf;
}
# 1370 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
void append_redir(char_u *buf, int buflen, char_u *opt, char_u *fname)
{
  ...
  for (p = opt; (p = vim_strchr(p, '%')) != ((void*)0); ++p) {
    if (p[1] == 's')
      break;
    if (p[1] == '%')
      ++p;
...
static int no_viminfo(void)
{
  ...
  return use_viminfo != ((void*)0) && strcmp((char *)(use_viminfo), (char *)("NONE")) == 0;
}
...
{
  vim_snprintf((char *)IObuff, (1024+1), libintl_gettext((char *)("%sviminfo: %s in line: ")),
      errnum, message);
  __builtin___strncat_chk ((char *)(IObuff), (char *)(line), (size_t)((1024+1) - strlen((char *)(IObuff)) - 1), __builtin_object_size ((char *)(IObuff), 2 > 1 ? 1 : 0));
  if (IObuff[strlen((char *)(IObuff)) - 1] == '\n')
    IObuff[strlen((char *)(IObuff)) - 1] = '\000';
  emsg(IObuff);
  if (++viminfo_errcnt >= 10) {
    emsg((char_u *)(libintl_gettext((char *)("E136: viminfo: Too many errors, skipping rest of file"))));
    return 1;
  }
  return 0;
}
...
)
{
  ...
  if (p_verbose > 0) {
    verbose_enter();
    smsg(libintl_gettext((char *)("Reading viminfo file \"%s\"%s%s%s")),
        fname,
        (flags & 1) ? libintl_gettext((char *)(" info")) : "",
        (flags & 2) ? libintl_gettext((char *)(" marks")) : "",
        (flags & 8) ? libintl_gettext((char *)(" oldfiles")) : "",
        fp == ((void*)0) ? libintl_gettext((char *)(" FAILED")) : "");
    verbose_leave();
  }
  ...
  viminfo_errcnt = 0;
  do_viminfo(fp, ((void*)0), flags);

  fclose(fp);
  return 1;
}
# 1469 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
void write_viminfo(char_u *file, int forceit)
{
  char_u *fname;
  FILE *fp_in = ((void*)0);
  FILE *fp_out = ((void*)0);
  char_u *tempname = ((void*)0);
  char_u *wp;
  ...
  if (fp_in == ((void*)0)) {
    ...
    fp_out = fopen(((char *)fname), ("wb"));

    (void)umask(umask_save);

  } else {
# 1514 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
    FileInfo old_info;
    if (os_fileinfo((char *)fname, &old_info)
      ...
      emsg2((char_u *)(libintl_gettext((char *)("E137: Viminfo file is not writable: %s"))), (char_u *)(fname));
      msg_didany = tt;
      fclose(fp_in);
      goto end;
    }
    ...
    tempname = (char_u *)modname((char *)fname, ".tmp", 0);
    if (tempname != ((void*)0)) {
      ...
      if (os_file_exists(tempname)) {
        ...
        wp = tempname + strlen((char *)(tempname)) - 5;
        if (wp < path_tail(tempname))
  ...
  if (fp_out == ((void*)0)) {
    emsg2((char_u *)(libintl_gettext((char *)("E138: Can't write viminfo file %s!"))), (char_u *)((fp_in == ((void*)0) || tempname == ((void*)0)) ? fname : tempname));
  ...
  if (p_verbose > 0) {
    verbose_enter();
    smsg(libintl_gettext((char *)("Writing viminfo file \"%s\"")), fname);
    verbose_leave();
  }

  viminfo_errcnt = 0;
  do_viminfo(fp_in, fp_out, forceit ? 0 : (1 | 2));
  ...
  if (fp_in != ((void*)0)) {
    ...
    if (viminfo_errcnt == 0 && vim_rename(tempname, fname) == -1) {
      viminfo_errcnt++;
      emsg2((char_u *)(libintl_gettext((char *)("E886: Can't rename viminfo file to %s!"))), (char_u *)(fname));
    }
    if (viminfo_errcnt > 0) {
...
# 1654 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
static char_u *viminfo_filename(char_u *file)
{
  if (file == ((void*)0) || *file == '\000') {
    if (use_viminfo != ((void*)0))
      file = use_viminfo;
    else if ((file = find_viminfo_parameter('n')) == ((void*)0) || *file == '\000') {
# 1671 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
      file = (char_u *)"~/.nviminfo";
    }
...
static void do_viminfo(FILE *fp_in, FILE *fp_out, int flags)
{
  ...
  vir.vir_line = xmalloc(512);
  vir.vir_fd = fp_in;
  vir.vir_conv.vc_type = 0;

  if (fp_in != ((void*)0)) {
    if (flags & 1) {
      eof = read_viminfo_up_to_marks(&vir,
          flags & 4, fp_out != ((void*)0));
      merge = 1;
    } else if (flags != 0)
  ...
  if (fp_out != ((void*)0)) {
    ...
    fprintf(fp_out, libintl_gettext((char *)("# This viminfo file was generated by Nvim %s.\n")),
        mediumVersion);
    fputs(libintl_gettext((char *)("# You may edit it if you're careful!\n\n")), fp_out);
    fputs(libintl_gettext((char *)("# Value of 'encoding' when this file was written\n")), fp_out);
  ...
  xfree(vir.vir_line);
  if (vir.vir_conv.vc_type != 0)
    convert_setup(&vir.vir_conv, ((void*)0), ((void*)0));
}
...
static int read_viminfo_up_to_marks(vir_T *virp, int forceit, int writing)
{
  ...
  while (!eof && virp->vir_line[0] != '>') {
    ...
    case '\'':
      ...
      break;
    default:
      if (viminfo_error("E575: ", libintl_gettext((char *)("Illegal starting char")),
              virp->vir_line))
        eof = 1;
      else
        eof = viminfo_readline(virp);
...
# 1850 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
char_u *
viminfo_readstring (
    vir_T *virp,
    int off,
  ...
  FUNC_ATTR_NONNULL_RET
{
  ...
  if (virp->vir_line[off] == 22 && ascii_isdigit(virp->vir_line[off + 1])) {
  ...
  *d = '\000';
  ...
  if (convert && virp->vir_conv.vc_type != 0 && *retval != '\000') {
    d = string_convert(&virp->vir_conv, retval, ((void*)0));
    if (d != ((void*)0)) {
      xfree(retval);
      retval = d;
    }
...
# 1907 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
...
# 2062 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
int do_write(exarg_T *eap)
{
  ...
  if (!other && (
        ...
        check_fname() == 0 || check_readonly(&eap->forceit, curbuf)))
    goto theend;
...
)
{
  ...
  if ( (other
    ...
    if (!eap->forceit && !eap->append) {
      ...
      if (os_isdir(ffname)) {
        emsg2((char_u *)(libintl_gettext((char *)(e_isadir2))), (char_u *)(ffname));
        return 0;
      }
    ...
    if (other && !emsg_silent) {
      ...
      if (*p_dir == '\000') {
        dir = xmalloc(5);
        __builtin___strcpy_chk ((char *)(dir), (char *)("."), __builtin_object_size ((char *)(dir), 2 > 1 ? 1 : 0));
      } else {
        dir = xmalloc(1024);
        p = p_dir;
      ...
      if (os_file_exists(swapname)) {
        if (p_confirm || cmdmod.confirm) {
          ...
          emsg2((char_u *)(libintl_gettext((char *)("E768: Swap file exists: %s (:silent! overrides)"))), (char_u *)(swapname));
...
void do_wqall(exarg_T *eap)
{
  ...
  for (buf_T *buf = firstbuf; buf != ((void*)0); buf = buf->b_next) {
    ...
    if (buf->b_ffname == ((void*)0)) {
      emsgn((char_u *)(libintl_gettext((char *)("E141: No file name for buffer %" "ll" "d"))), (int64_t)(buf->b_fnum));
      ++error;
...
static int check_readonly(int *forceit, buf_T *buf)
{
  ...
  if (!*forceit && (buf->b_p_ro
    ...
    if ((p_confirm || cmdmod.confirm) && buf->b_fname != ((void*)0)) {
      ...
      emsg2((char_u *)(libintl_gettext((char *)("E505: \"%s\" is read-only (add ! to override)"))), (char_u *)(buf->b_fname));
...
# 2438 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
...
# 2522 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
int
do_ecmd (
    int fnum,
    char_u *ffname,
...
)
{
  ...
  if ((command != ((void*)0) || newlnum > (linenr_T)0)
    ...
    size_t len = (command != ((void*)0)) ? strlen((char *)(command)) + 3 : 30;
    p = xmalloc(len);
    if (command != ((void*)0)) {
      vim_snprintf((char *)p, len, ":%s\r", command);
    } else {
      vim_snprintf((char *)p, len, "%" "ll" "d" "G", (int64_t)newlnum);
    }
  ...
  if (other_file) {
    ...
    if (buf != curbuf) {
# 2706 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
      ...
      if (buf == curbuf)
        ...
        close_buffer(oldwin, curbuf,
            (flags & 0x01) || curbuf->terminal ? 0 : DOBUF_UNLOAD, 0);




        if (curwin != oldwin && oldwin != aucmd_win && win_valid(oldwin)) {
          (__builtin_expect(!(oldwin), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c", 2733, "oldwin") : (void)0);
  ...
  did_filetype = 0;
# 2821 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
...
{
  emsg2((char_u *)(libintl_gettext((char *)("E143: Autocommands unexpectedly deleted new buffer %s"))), (char_u *)(name == ((void*)0) ? (char_u *)"" : name));
...
static char_u *old_sub = ((void*)0);
static int global_need_beginline;
# 3378 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
void do_sub(exarg_T *eap)
{
  ...
  static int do_all = 0;
  static int do_ask = 0;
  static _Bool do_count = 0;
  static int do_error = 1;
  ...
  if (eap->cmd[0] == 's' && *cmd != '\000' && !ascii_iswhite(*cmd)
    ...
    while (cmd[0]) {
      ...
      if (cmd[0] == '\\' && cmd[1] != 0)
        ++cmd;
      (cmd += has_mbyte ? (*mb_ptr2len)((char_u *)cmd) : 1);
    }

    if (!eap->skip) {

      if (strcmp((char *)(sub), (char *)("%")) == 0
  ...
  if (!do_count && !(!curbuf->terminal && curbuf->b_p_ma)) {

    emsg((char_u *)(libintl_gettext((char *)(e_modifiable))));
    return;
  }

  if (search_regcomp(pat, 1, which_pat, 0x20,
          &regmatch) == 0) {
    if (do_error)
...
# 3719 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
      sub_firstlnum = lnum;
      copycol = 0;
      matchcol = 0;
...
# 3737 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
      for (;; ) {
        ...
        if (do_ask) {
          ...
          while (do_ask) {
            if (exmode_active) {
              ...
              if (do_number || curwin->w_onebuf_opt.wo_nu) {
        ...
        needed_len = copy_len + ((unsigned)strlen((char *)(p1))
        ...
        if (new_start == ((void*)0)) {
          ...
          *new_start = '\000';
          ...
          len = (unsigned)strlen((char *)(new_start));
          needed_len += len;
...
# 4092 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
          ...
          if (p1[0] == '\\' && p1[1] != '\000')
            ...
            if (u_inssub(lnum) == 1) {
              *p1 = '\000';
              ...
              mark_adjust(lnum + 1, (linenr_T)0x7fffffff, 1L, 0L);
              if (do_ask)
...
skip:
        ...
        nmatch = -1;
# 4152 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
        if (lastone
            || nmatch_tl > 0
          ...
          if (new_start != ((void*)0)) {
            ...
            __builtin___strcat_chk ((char *)(new_start), (char *)(sub_firstline + copycol), __builtin_object_size ((char *)(new_start), 2 > 1 ? 1 : 0));
  ...
  if (sub_nsubs > start_nsubs) {
    ...
    if (got_int)
      ...
      emsg2((char_u *)(libintl_gettext((char *)(e_patnotf2))), (char_u *)(get_search_pat()));
  }
...
)
{
  ...
  if (((sub_nsubs > p_report && (KeyTyped || sub_nlines > 1 || p_report < 1))
      ...
      && messaging()) {
    if (got_int)
      __builtin___strcpy_chk ((char *)(msg_buf), (char *)(libintl_gettext((char *)("(Interrupted) "))), __builtin_object_size ((char *)(msg_buf), 2 > 1 ? 1 : 0));
    else
      *msg_buf = '\000';
    if (sub_nsubs == 1)
...
# 4359 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
...
int read_viminfo_sub_string(vir_T *virp, int force)
{
  if (force)
    xfree(old_sub);
  if (force || old_sub == ((void*)0))
    old_sub = viminfo_readstring(virp, 1, 1);
  return viminfo_readline(virp);
}

void write_viminfo_sub_string(FILE *fp)
{
  if (get_viminfo_parameter('/') != 0 && old_sub != ((void*)0)) {
    fputs(libintl_gettext((char *)("\n# Last Substitute String:\n$")), fp);
    viminfo_writestring(fp, old_sub);
  }
}
# 4539 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
_Bool
prepare_tagpreview (
    _Bool undo_sync
)
...
void ex_help(exarg_T *eap)
{
  ...
  if (i >= num_matches || n == 0) {
    if (lang != ((void*)0))
      emsg3((char_u *)(libintl_gettext((char *)("E661: Sorry, no '%s' help for %s"))), (char_u *)(lang), (char_u *)(arg));
    else
      emsg2((char_u *)(libintl_gettext((char *)("E149: Sorry, no help for %s"))), (char_u *)(arg));
    if (n != 0)
...
# 4774 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
int
help_heuristic (
...
)
{
  ...
  for (p = matched_string; *p; p++)
    if (((((unsigned)(*p) >= 'A' && (unsigned)(*p) <= 'Z') || ((unsigned)(*p) >= 'a' && (unsigned)(*p) <= 'z')) || ascii_isdigit(*p)))
      num_letters++;
# 4798 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
...
int find_help_tags(char_u *arg, int *num_matches, char_u ***matches, int keep_lang)
{
  ...
  for (i = (int)((sizeof(mtable)/sizeof((mtable)[0])) / ((size_t)(!(sizeof(mtable) % sizeof((mtable)[0]))))); --i >= 0; )
    if (strcmp((char *)(arg), (char *)(mtable[i])) == 0) {
      __builtin___strcpy_chk ((char *)(d), (char *)(rtable[i]), __builtin_object_size ((char *)(d), 2 > 1 ? 1 : 0));
      break;
    }
    ...
    if (arg[0] == '\\'
        && ((arg[1] != '\000' && arg[2] == '\000')
            || (vim_strchr((char_u *)"%_z@", arg[1]) != ((void*)0)
                && arg[2] != '\000'))) {
      __builtin___strcpy_chk ((char *)(d), (char *)("/\\\\"), __builtin_object_size ((char *)(d), 2 > 1 ? 1 : 0));
      __builtin___strcpy_chk ((char *)(d + 3), (char *)(arg + 1), __builtin_object_size ((char *)(d + 3), 2 > 1 ? 1 : 0));

      if (d[3] == '_' && d[4] == '$')
        __builtin___strcpy_chk ((char *)(d + 4), (char *)("\\$"), __builtin_object_size ((char *)(d + 4), 2 > 1 ? 1 : 0));
    } else {
      ...
      for (s = arg; *s; ++s) {
# 4903 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
        if (d - IObuff > (1024+1) - 10)
          break;
        switch (*s) {
        case '|': __builtin___strcpy_chk ((char *)(d), (char *)("bar"), __builtin_object_size ((char *)(d), 2 > 1 ? 1 : 0));
          d += 3;
          continue;
        case '"': __builtin___strcpy_chk ((char *)(d), (char *)("quote"), __builtin_object_size ((char *)(d), 2 > 1 ? 1 : 0));
          d += 5;
          continue;
        case '*': *d++ = '.';
          break;
        ...
        if (*s < ' ' || (*s == '^' && s[1] && ((((unsigned)(s[1]) >= 'A' && (unsigned)(s[1]) <= 'Z') || ((unsigned)(s[1]) >= 'a' && (unsigned)(s[1]) <= 'z'))
          ...
          if (d > IObuff && d[-1] != '_' && d[-1] != '\\')
            *d++ = '_';
          __builtin___strcpy_chk ((char *)(d), (char *)("CTRL-"), __builtin_object_size ((char *)(d), 2 > 1 ? 1 : 0));
          d += 5;
          if (*s < ' ') {
            *d++ = *s + '@';
            if (d[-1] == '\\')
...
static void prepare_help_buffer(void)
{
  ...
  if (strcmp((char *)(curbuf->b_p_isk), (char *)(p)) != 0) {
    set_string_option_direct((char_u *)"isk", -1, p, 1|4, 0);
...
void fix_help_buffer(void)
{
  ...
  set_option_value((char_u *)"ft", 0L, (char_u *)"help", 4);
  ...
  if (vim_fnamecmp((char_u *)(fname), (char_u *)("help.txt")) == 0
      || (vim_fnamencmp((char_u *)(fname), (char_u *)("help."), (size_t)(5)) == 0
    ...
    for (lnum = 1; lnum < curbuf->b_ml.ml_line_count; ++lnum) {
      ...
      while (*p != '\000') {
        ...
        if (path_full_compare(rt, NameBuff, 0) != kEqualFiles) {
          ...
          __builtin___strcat_chk ((char *)(NameBuff), (char *)("doc/*.??[tx]"), __builtin_object_size ((char *)(NameBuff), 2 > 1 ? 1 : 0));
          ...
          if (gen_expand_wildcards(1, buff_list, &fcount,
            ...
            for (i1 = 0; i1 < fcount; ++i1) {
              for (i2 = 0; i2 < fcount; ++i2) {
                ...
                f2 = fnames[i2];
                t1 = path_tail(f1);
                if (vim_fnamencmp((char_u *)(f1), (char_u *)(f2), (size_t)(t1 - f1)) != 0)
                  continue;
                e1 = vim_strrchr(t1, '.');
                e2 = vim_strrchr(path_tail(f2), '.');
                if (e1 == '\000' || e2 == '\000')
                  continue;
                if (vim_fnamecmp((char_u *)(e1), (char_u *)(".txt")) != 0
                    && vim_fnamecmp((char_u *)(e1), (char_u *)(fname + 4)) != 0) {

                  xfree(fnames[i1]);
                  fnames[i1] = ((void*)0);
                  continue;
                }
                if (vim_fnamencmp((char_u *)(f1), (char_u *)(f2), (size_t)(e1 - f1)) != 0)
                  continue;
                if (vim_fnamecmp((char_u *)(e1), (char_u *)(".txt")) == 0
                    && vim_fnamecmp((char_u *)(e2), (char_u *)(fname + 4)) == 0) {
...
void ex_helptags(exarg_T *eap)
{
  ...
  __builtin___strcpy_chk ((char *)(NameBuff), (char *)(dirname), __builtin_object_size ((char *)(NameBuff), 2 > 1 ? 1 : 0));
  add_pathsep((char *)NameBuff);
  __builtin___strcat_chk ((char *)(NameBuff), (char *)("**"), __builtin_object_size ((char *)(NameBuff), 2 > 1 ? 1 : 0));
  ...
  if (gen_expand_wildcards(1, buff_list, &filecount, &files,
          0x02|0x20) == 0
      || filecount == 0) {
    emsg2((char_u *)("E151: No match: %s"), (char_u *)(NameBuff));
    xfree(dirname);
    return;
  }
  ...
  for (int j = 0; j < ga.ga_len; j += 2) {
    __builtin___strcpy_chk ((char *)(fname), (char *)("tags-xx"), __builtin_object_size ((char *)(fname), 2 > 1 ? 1 : 0));
    fname[5] = ((char_u *)ga.ga_data)[j];
    fname[6] = ((char_u *)ga.ga_data)[j + 1];
    if (fname[5] == 'e' && fname[6] == 'n') {

      fname[4] = '\000';
      __builtin___strcpy_chk ((char *)(ext), (char *)(".txt"), __builtin_object_size ((char *)(ext), 2 > 1 ? 1 : 0));
    } else {

      __builtin___strcpy_chk ((char *)(ext), (char *)(".xxx"), __builtin_object_size ((char *)(ext), 2 > 1 ? 1 : 0));
      ext[1] = fname[5];
      ext[2] = fname[6];
    }
...
)
{
  ...
  dirlen = (int)strlen((char *)(dir));
  __builtin___strcpy_chk ((char *)(NameBuff), (char *)(dir), __builtin_object_size ((char *)(NameBuff), 2 > 1 ? 1 : 0));
  __builtin___strcat_chk ((char *)(NameBuff), (char *)("/**/*"), __builtin_object_size ((char *)(NameBuff), 2 > 1 ? 1 : 0));
  __builtin___strcat_chk ((char *)(NameBuff), (char *)(ext), __builtin_object_size ((char *)(NameBuff), 2 > 1 ? 1 : 0));
  ...
  __builtin___strcpy_chk ((char *)(NameBuff), (char *)(dir), __builtin_object_size ((char *)(NameBuff), 2 > 1 ? 1 : 0));
  add_pathsep((char *)NameBuff);
  __builtin___strcat_chk ((char *)(NameBuff), (char *)(tagfname), __builtin_object_size ((char *)(NameBuff), 2 > 1 ? 1 : 0));
  fd_tags = fopen(((char *)NameBuff), ("w"));
  if (fd_tags == ((void*)0)) {
    emsg2((char_u *)(libintl_gettext((char *)("E152: Cannot open %s for writing"))), (char_u *)(NameBuff));
    FreeWild(filecount, files);
    return;
  }
  ...
  if (add_help_tags || path_full_compare((char_u *)"$VIMRUNTIME/doc",
    ...
    __builtin___sprintf_chk ((char *)s, 0, __builtin_object_size ((char *)s, 2 > 1 ? 1 : 0), "help-tags\t%s\t1\n", tagfname);
  ...
  for (fi = 0; fi < filecount && !got_int; ++fi) {
    ...
    if (fd == ((void*)0)) {
      emsg2((char_u *)(libintl_gettext((char *)("E153: Unable to open %s for reading"))), (char_u *)(files[fi]));
      continue;
    }
    ...
    while (!vim_fgets(IObuff, (1024+1), fd) && !got_int) {
      if (firstline) {
        ...
        if (utf8 == 2)
          ...
          emsg2((char_u *)(libintl_gettext((char *)("E670: Mix of help file encodings within a language: %s"))), (char_u *)(files[fi]));
        ...
        if (p2 != ((void*)0) && p2 > p1 + 1) {
          ...
          if (s == p2
            ...
            *p2 = '\0';
            ...
            do { ga_grow(&ga, 1); ((char_u * *)(&ga)->ga_data)[(&ga)->ga_len++] = (s); } while (0);
            __builtin___sprintf_chk ((char *)s, 0, __builtin_object_size ((char *)s, 2 > 1 ? 1 : 0), "%s\t%s", p1, fname);
...
void ex_sign(exarg_T *eap)
{
    ...
    if (idx == 6)
    {
 emsg2((char_u *)(libintl_gettext((char *)("E160: Unknown sign command: %s"))), (char_u *)(arg));
 return;
    }
    arg = skipwhite(p);
  ...
  *p++ = '\000';
  ...
  for (;;)
  {
   ...
   {
       *p = '\000';
       emsg2((char_u *)(libintl_gettext((char *)("E239: Invalid sign text: %s"))), (char_u *)(arg));
       return;
   }
   ...
   if (cells == 1)
       __builtin___strcpy_chk ((char *)(sp->sn_text + len - 1), (char *)(" "), __builtin_object_size ((char *)(sp->sn_text + len - 1), 2 > 1 ? 1 : 0));
      }
  ...
  emsg2((char_u *)(libintl_gettext((char *)("E155: Unknown sign: %s"))), (char_u *)(arg));
     else if (idx == 2)
 ...
 if (buf == ((void*)0))
 {
     emsg2((char_u *)(libintl_gettext((char *)("E158: Invalid buffer name: %s"))), (char_u *)(arg));
 }
 ...
 else if (idx == 5)
 {
  ...
  {
      char *cmd = xmalloc(strlen((char *)(buf->b_fname)) + 25);
      __builtin___sprintf_chk (cmd, 0, __builtin_object_size (cmd, 2 > 1 ? 1 : 0), "e +%" "ll" "d" " %s", (int64_t)lnum, buf->b_fname);
  ...
  emsgn((char_u *)(libintl_gettext((char *)("E157: Invalid sign ID: %" "ll" "d"))), (int64_t)(id));
 }
 else if (idx == 4)
 {
     if (lnum >= 0 || sign_name != ((void*)0))
 ...
 else if (sign_name != ((void*)0))
 {
  ...
  if (strcmp((char *)(sp->sn_name), (char *)(sign_name)) == 0)
     ...
     if (sp == ((void*)0))
     {
  emsg2((char_u *)(libintl_gettext((char *)("E155: Unknown sign: %s"))), (char_u *)(sign_name));
  return;
     }
     if (lnum > 0)
  ...
  lnum = buf_change_sign_type(buf, id, sp->sn_typenr);
            if (lnum > 0)
                ...
                emsg2((char_u *)(libintl_gettext((char *)("E885: Not possible to change sign %s"))), (char_u *)(sign_name));
 }
 else
     emsg((char_u *)(libintl_gettext((char *)(e_invarg))));
    }
...
static void sign_list_defined(sign_T *sp)
{
  ...
  if (sp->sn_icon != ((void*)0)) {
    msg_puts((char_u *)(" icon="));
    msg_outtrans(sp->sn_icon);
    msg_puts((char_u *)(libintl_gettext((char *)(" (not supported)"))));
  }
  if (sp->sn_text != ((void*)0)) {
    msg_puts((char_u *)(" text="));
    msg_outtrans(sp->sn_text);
  }
  if (sp->sn_line_hl > 0) {
    msg_puts((char_u *)(" linehl="));
    p = get_highlight_name(((void*)0), sp->sn_line_hl - 1);
    if (p == ((void*)0))
  ...
  if (sp->sn_text_hl > 0) {
    msg_puts((char_u *)(" texthl="));
    p = get_highlight_name(((void*)0), sp->sn_text_hl - 1);
    if (p == ((void*)0))
      msg_puts((char_u *)("NONE"));
    else
      msg_puts(p);
...
# 6145 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
static enum
{
    EXP_SUBCMD,
    EXP_DEFINE,
...
char_u * get_sign_name(expand_T *xp, int idx)
{
    ...
    case EXP_DEFINE:
 {
     char *define_arg[] =
     {
  "icon=", "linehl=", "text=", "texthl=", ((void*)0)
     };
...
# 6258 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.c"
  do
  {
    p = skipwhite(p);
    last = p;
