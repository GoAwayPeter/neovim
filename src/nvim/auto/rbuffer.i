...
{
  (__builtin_expect(!(count && count <= rbuffer_space(buf)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/rbuffer.c", 87, "count && count <= rbuffer_space(buf)") : (void)0);
...
{
  (__builtin_expect(!(count && count <= buf->size), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/rbuffer.c", 130, "count && count <= buf->size") : (void)0);
...
{
  (__builtin_expect(!(index < buf->size), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/rbuffer.c", 189, "index < buf->size") : (void)0);
...
int rbuffer_cmp(RBuffer *buf, const char *str, size_t count)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(count <= buf->size), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/rbuffer.c", 200, "count <= buf->size") : (void)0);
  size_t rcnt;
