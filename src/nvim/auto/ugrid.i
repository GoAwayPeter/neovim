# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c" 2
...
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c" 2
...
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.c" 2
...
{
  grid->attrs = ((HlAttrs){0, 0, 0, 0, 0, -1, -1});
  grid->fg = grid->bg = -1;
  grid->cells = ((void*)0);
}
...
void ugrid_scroll(UGrid *grid, int count, int *clear_top, int *clear_bot)
{
  ...
  for (i = start; i != stop; i += step) {
    ...
    __builtin___memcpy_chk (target_row, source_row, sizeof(UCell) * (size_t)(grid->right - grid->left + 1), __builtin_object_size (target_row, 0));
...
static void clear_region(UGrid *grid, int top, int bot, int left, int right)
{
  ...
  do { for (int row = top; row <= bot; ++row) { UCell *row_cells = (grid)->cells[row]; for (int col = left; col <= right; ++col) { UCell *cell = row_cells + col; (void)(cell); { cell->data[0] = ' '; cell->data[1] = 0; cell->attrs = clear_attrs; }; } } } while (0);
