...
} key_names_table[] =
{
  ...
  {(-((253) + ((int)(KE_PASTE) << 8))), (char_u *)"Paste"},
  {(-((253) + ((int)(KE_FOCUSGAINED) << 8))), (char_u *)"FocusGained"},
  {(-((253) + ((int)(KE_FOCUSLOST) << 8))), (char_u *)"FocusLost"},
  {0, ((void*)0)}
};
...
)
{
  ...
  if (((key) < 0)) {
    ...
    (__builtin_expect(!(after >= dst && (uintmax_t)(after - dst) <= (2147483647 *2U +1U)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/keymap.c", 522, "after >= dst && (uintmax_t)(after - dst) <= UINT_MAX") : (void)0);
...
# 710 "/Users/George/Documents/Programs/C/neovim/src/nvim/keymap.c"
...
# 760 "/Users/George/Documents/Programs/C/neovim/src/nvim/keymap.c"
