...
static slang_T *spell_load_file(char_u *fname, char_u *lang, slang_T *old_lp, _Bool silent );
...
static void onecap_copy(char_u *word, char_u *wcopy, _Bool upper );
...
static void add_suggestion(suginfo_T *su, garray_T *gap, char_u *goodword, int badlenarg, int score, int altscore, _Bool had_bonus, slang_T *slang, _Bool maxsf );
...
static void spell_soundfold(slang_T *slang, char_u *inword, _Bool folded, char_u *res );
