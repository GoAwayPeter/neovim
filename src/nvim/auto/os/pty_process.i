# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
void *valloc(size_t);
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
extern int optreset;
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
pid_t tcgetsid(int);
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
# 17 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
# 22 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/func_attr.h" 1
# 24 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
# 25 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h" 1
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h"
...
# 27 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.c" 2
...
static _Bool set_pipe_duplicating_descriptor(int fd, uv_pipe_t *pipe)
  FUNC_ATTR_NONNULL_ALL
{
  int fd_dup = dup(fd);
  if (fd_dup < 0) {
    do_log(3, __func__, 78, 1, "Failed to dup descriptor %d: %s", fd, strerror((*__error())));
    return 0;
  }
  int uv_result = uv_pipe_open(pipe, fd_dup);
  if (uv_result) {
    do_log(3, __func__, 84, 1, "Failed to set pipe to descriptor %d: %s", fd_dup, uv_strerror(uv_result));
...
static const unsigned int KILL_TIMEOUT = 2;
...
_Bool pty_process_spawn(Job *job) FUNC_ATTR_NONNULL_ALL
{
  ...
  int pid = forkpty(&master, ((void*)0), &termios, &ptyproc->winsize);
  ...
  if (master_status_flags == -1) {
    do_log(3, __func__, 115, 1, "Failed to get master descriptor status flags: %s", strerror((*__error())));
    goto error;
  }
  if (fcntl(master, 4, master_status_flags | 0x0004) == -1) {
    do_log(3, __func__, 119, 1, "Failed to make master descriptor non-blocking: %s", strerror((*__error())));
    goto error;
  }
...
error:
  ...
  int status, child;
  unsigned int try = 0;
  while (try++ < KILL_RETRIES && !(child = waitpid(pid, &status, 0x00000001))) {
    sleep(KILL_TIMEOUT);
  }
  if (child != pid) {
    kill(pid, 9);
...
static void init_child(Job *job) FUNC_ATTR_NONNULL_ALL
{
  ...
  fprintf(__stderrp, "execvp failed: %s\n", strerror((*__error())));
}

static void init_termios(struct termios *termios) FUNC_ATTR_NONNULL_ALL
{
  __builtin___memset_chk (termios, 0, sizeof(struct termios), __builtin_object_size (termios, 0));
