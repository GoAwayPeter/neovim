...
static void create_cursorhold_event(void)
{
  ...
  (__builtin_expect(!(!events_enabled || queue_empty(loop.events)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.c", 89, "!events_enabled || queue_empty(loop.events)") : (void)0);
    ...
    _Bool at_eof)
{
  ...
  (__builtin_expect(!(rbuffer_space(input_buffer) >= rbuffer_size(buf)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.c", 351, "rbuffer_space(input_buffer) >= rbuffer_size(buf)") : (void)0);
