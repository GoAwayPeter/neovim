...
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.c" 2
...
# 18 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.c" 2
...
void input_start(int fd)
{
  ...
  global_fd = fd;
  rstream_init_fd(&loop, &read_stream, fd, 0xfff, ((void*)0));
...
void input_stop(void)
{
  ...
  stream_close(&read_stream, ((void*)0));
}
...
static void create_cursorhold_event(void)
{
  ...
  (__builtin_expect(!(!events_enabled || queue_empty(loop.events)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.c", 90, "!events_enabled || queue_empty(loop.events)") : (void)0);
  queue_put_event(loop.events, event_create(1, cursorhold_event, 0));;
}
...
static _Bool input_poll(int ms)
{
  ...
  do { int remaining = ms; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(input_ready() || input_eof)) { do { if (((void*)0) && !queue_empty(((void*)0))) { queue_process_events(((void*)0)); } else { loop_poll_events(&loop, remaining); } } while (0); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
    ...
    _Bool at_eof)
{
  ...
  (__builtin_expect(!(rbuffer_space(input_buffer) >= rbuffer_size(buf)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.c", 352, "rbuffer_space(input_buffer) >= rbuffer_size(buf)") : (void)0);
