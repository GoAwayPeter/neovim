...
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/vim.h"
                        ...
                        _Bool forward_output)
{
  ...
  proc->events = events;
  proc->argv = argv;
  proc->in = input != ((void*)0) ? &in : ((void*)0);
  proc->out = &out;
  proc->err = &err;
  ...
  if (input != ((void*)0)) {
    proc->in->events = ((void*)0);
    wstream_init(proc->in, 0);
  }
  proc->out->events = ((void*)0);
  rstream_init(proc->out, 0);
  rstream_start(proc->out, data_cb);
  proc->err->events = ((void*)0);
  ...
  ui_busy_start();
  ui_flush();
  int status = process_wait(proc, -1, ((void*)0));
  ui_busy_stop();
  ...
  (__builtin_expect(!(queue_empty(events)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/shell.c", 280, "queue_empty(events)") : (void)0);
  queue_free(events);
...
{
  if (buf->cap >= desired) {
    (__builtin_expect(!(buf->data), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/shell.c", 292, "buf->data") : (void)0);
    return;
  }
    ...
    _Bool eof)
{
  ...
  size_t written = write_output(ptr, cnt, 0, eof);
...
# 341 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/shell.c"
                           ...
                           _Bool eof)
{
  ...
  char replacement_NUL = to_buffer ? '\012' : 1;
