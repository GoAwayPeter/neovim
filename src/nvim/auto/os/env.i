...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/env.c" 2
...
char *vim_getenv(const char *name)
{
  ...
  if (vim_path == ((void*)0)) {
    ...
    if (vim_path != ((void*)0)) {
      ...
      (__builtin_expect(!(vim_path_end >= vim_path), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/env.c", 480, "vim_path_end >= vim_path") : (void)0);
...
# 529 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/env.c"
void home_replace(buf_T *buf, char_u *src, char_u *dst, int dstlen, _Bool one)
{
  ...
  if (!one)
    src = skipwhite(src);
  while (*src && dstlen > 0) {
# 584 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/env.c"
    char_u *p = homedir;
    len = dirlen;
    for (;; ) {
      if ( len
...
char_u *get_env_name(expand_T *xp, int idx)
{
  ...
  (__builtin_expect(!(idx >= 0), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/env.c", 662, "idx >= 0") : (void)0);
