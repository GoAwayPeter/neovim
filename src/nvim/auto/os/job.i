# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2
...
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/uv_helpers.h" 1
...
typedef void (*wstream_cb)(WStream *wstream,
                           void *data,
                           int status);
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/uv_helpers.h" 2
...
typedef void (*rstream_cb)(RStream *rstream, RBuffer *buf, void *data,
    _Bool eof);
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/uv_helpers.h" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/uv_helpers.h" 2
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.h" 1
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.h"
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h" 1
...
void *valloc(size_t);
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h" 2





# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pipe_process.h" 1
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/pty_process.h" 1
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h" 2
...
# 13 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h" 2
...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h" 2
...
# 15 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job_private.h" 2
...
static inline _Bool process_spawn(Job *job)
{
...
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/rstream.h" 1
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2
...
# 16 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2


# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/vim.h" 1
# 15 "/Users/George/Documents/Programs/C/neovim/src/nvim/vim.h"
...
# 19 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c" 2
# 46 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c"
Job *table[100] = {((void*)0)};
size_t stop_requests = 0;
uv_timer_t job_stop_timer;
uv_signal_t schld;
# 59 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c"
void job_init(void)
{
  uv_disable_stdio_inheritance();
  uv_timer_init(uv_default_loop(), &job_stop_timer);
  uv_signal_init(uv_default_loop(), &schld);
  uv_signal_start(&schld, chld_handler, 20);
}
...
void job_teardown(void)
{
  ...
  do { int remaining = -1; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(!stop_requests)) { event_poll(remaining); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
  uv_signal_stop(&schld);
  uv_close((uv_handle_t *)&schld, ((void*)0));

  uv_close((uv_handle_t *)&job_stop_timer, ((void*)0));
}
...
Job *job_start(JobOptions opts, int *status)
{
  ...
  *status = job->id;
  ...
  if (opts.stdout_cb) {
    job->out = rstream_new(read_cb, rbuffer_new(0xFFFF), job);
    rstream_set_stream(job->out, job->proc_stdout);
    rstream_start(job->out);
  }

  if (opts.stderr_cb) {
    job->err = rstream_new(read_cb, rbuffer_new(0xFFFF), job);
...
void job_stop(Job *job)
{
  ...
  if (job->opts.pty) {
    ...
    do { if (job->in) { wstream_free(job->in); job->in = ((void*)0); if (!uv_is_closing((uv_handle_t *)job->proc_stdin)) { uv_close((uv_handle_t *)job->proc_stdin, close_cb); } } } while (0);
  }
...
# 239 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c"
int job_wait(Job *job, int ms) FUNC_ATTR_NONNULL_ALL
{
  ...
  job->refcount++;
  do { int remaining = ms; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(got_int || job->refcount == 1)) { event_poll(remaining); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
  ...
  if (got_int) {
    ...
    if (ms == -1) {
      ...
      do { int remaining = -1; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(job->refcount == 1)) { event_poll(remaining); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
    } else {
      event_poll(0);
    }
  }
...
# 290 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c"
...
{
  do { if (job->out) { rstream_free(job->out); job->out = ((void*)0); if (!uv_is_closing((uv_handle_t *)job->proc_stdout)) { uv_close((uv_handle_t *)job->proc_stdout, close_cb); } } } while (0);
}
...
# 317 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c"
void job_write_cb(Job *job, wstream_cb cb) FUNC_ATTR_NONNULL_ALL
{
  wstream_set_write_cb(job->in, cb, job);
}
# 329 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.c"
...
void job_close_streams(Job *job)
{
  do { if (job->in) { wstream_free(job->in); job->in = ((void*)0); if (!uv_is_closing((uv_handle_t *)job->proc_stdin)) { uv_close((uv_handle_t *)job->proc_stdin, close_cb); } } } while (0);
  do { if (job->out) { rstream_free(job->out); job->out = ((void*)0); if (!uv_is_closing((uv_handle_t *)job->proc_stdout)) { uv_close((uv_handle_t *)job->proc_stdout, close_cb); } } } while (0);
  do { if (job->err) { rstream_free(job->err); job->err = ((void*)0); if (!uv_is_closing((uv_handle_t *)job->proc_stderr)) { uv_close((uv_handle_t *)job->proc_stderr, close_cb); } } } while (0);
}
...
static void job_stop_timer_cb(uv_timer_t *handle)
{
  ...
  for (size_t i = 0; i < 100; i++) {
    if ((job = table[i]) == ((void*)0) || !job->stopped_time) {
      continue;
    }

    uint64_t elapsed = now - job->stopped_time;

    if (!job->term_sent && elapsed >= 1000000000) {
      do_log(1, __func__, 395, 1, "Sending SIGTERM to job(id: %d)", job->id);
      uv_kill(job->pid, 15);
      job->term_sent = 1;
    } else if (elapsed >= (1000000000 * 2)) {
      do_log(1, __func__, 399, 1, "Sending SIGKILL to job(id: %d)", job->id);
      uv_kill(job->pid, 9);
      process_close(job);
    }
  }
...
static void chld_handler(uv_signal_t *handle, int signum)
{
  ...
  if ((((*(int *)&(stat)) & 0177) == 0177 && ((*(int *)&(stat)) >> 8) != 0x13) || (((*(int *)&(stat)) & 0177) == 0177 && ((*(int *)&(stat)) >> 8) == 0x13)) {
  ...
  for (int i = 0; i < 100; i++) {
    if ((job = table[i]) != ((void*)0) && job->pid == pid) {
      if ((((*(int *)&(stat)) & 0177) == 0)) {
        job->status = (((*(int *)&(stat)) >> 8) & 0x000000ff);
      } else if ((((*(int *)&(stat)) & 0177) != 0177 && ((*(int *)&(stat)) & 0177) != 0)) {
        job->status = (((*(int *)&(stat)) & 0177));
      }
      if (exiting) {

        process_close(job);
      } else {
        event_push((Event) {.handler = job_exited, .data = job}, 0);
      }
      break;
    }
  }
