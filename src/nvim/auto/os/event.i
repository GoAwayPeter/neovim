# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
void *valloc(size_t);
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.h" 2
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/server.h" 1
# 13 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.h" 1
# 15 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/rstream.h" 1
# 16 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.h" 1
# 18 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 20 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 21 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 22 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/screen.h" 1
# 23 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2
...
# 26 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c" 2



struct __kl1_Event { Event data; struct __kl1_Event *next; }; typedef struct __kl1_Event kl1_Event; typedef struct { size_t cnt, n, max; kl1_Event **buf; } kmp_Event_t; static inline kmp_Event_t *kmp_init_Event(void) { return xcalloc(1, sizeof(kmp_Event_t)); } static inline void kmp_destroy_Event(kmp_Event_t *mp) __attribute__((unused)); static inline void kmp_destroy_Event(kmp_Event_t *mp) { size_t k; for (k = 0; k < mp->n; ++k) { ; xfree(mp->buf[k]); } xfree(mp->buf); xfree(mp); } static inline kl1_Event *kmp_alloc_Event(kmp_Event_t *mp) { ++mp->cnt; if (mp->n == 0) return xcalloc(1, sizeof(kl1_Event)); return mp->buf[--mp->n]; } static inline void kmp_free_Event(kmp_Event_t *mp, kl1_Event *p) { --mp->cnt; if (mp->n == mp->max) { mp->max = mp->max? mp->max<<1 : 16; mp->buf = xrealloc(mp->buf, sizeof(kl1_Event *) * mp->max); } mp->buf[mp->n++] = p; } typedef struct { kl1_Event *head, *tail; kmp_Event_t *mp; size_t size; } kl_Event_t; static inline kl_Event_t *kl_init_Event(void) { kl_Event_t *kl = xcalloc(1, sizeof(kl_Event_t)); kl->mp = kmp_init_Event(); kl->head = kl->tail = kmp_alloc_Event(kl->mp); kl->head->next = 0; return kl; } static inline void kl_destroy_Event(kl_Event_t *kl) __attribute__((unused)); static inline void kl_destroy_Event(kl_Event_t *kl) { kl1_Event *p; for (p = kl->head; p != kl->tail; p = p->next) kmp_free_Event(kl->mp, p); kmp_free_Event(kl->mp, p); kmp_destroy_Event(kl->mp); xfree(kl); } static inline void kl_push_Event(kl_Event_t *kl, Event d) { kl1_Event *q, *p = kmp_alloc_Event(kl->mp); q = kl->tail; p->next = 0; kl->tail->next = p; kl->tail = p; ++kl->size; q->data = d; } static inline Event kl_shift_at_Event(kl_Event_t *kl, kl1_Event **n) { (__builtin_expect(!((*n)->next), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c", 29, "(*n)->next") : (void)0); kl1_Event *p; --kl->size; p = *n; *n = (*n)->next; if (p == kl->head) kl->head = *n; Event d = p->data; kmp_free_Event(kl->mp, p); return d; }
# 38 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/event.c"
static kl_Event_t *deferred_events = ((void*)0), *immediate_events = ((void*)0);
static int deferred_events_allowed = 0;

void event_init(void)
{

  deferred_events = kl_init_Event();
  immediate_events = kl_init_Event();
...
{
  return deferred_events_allowed && !((deferred_events)->size == 0);
}
...
void event_push(Event event, _Bool deferred)
{
  ...
  kl_push_Event(deferred ? deferred_events : immediate_events, event);
}
...
{
  while (!((queue)->size == 0)) {
    Event event = kl_shift_at_Event(queue, &queue->head);
    event.handler(event);
  }
}
