...
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.c" 2
...
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/misc1.h" 1
# 13 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.c" 2
...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.h" 2
# 15 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.c" 2
...
# 16 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.c" 2
...
void signal_init(void)
{
  ...
  uv_signal_start(&spipe, signal_cb, 13);
  uv_signal_start(&shup, signal_cb, 1);
  uv_signal_start(&squit, signal_cb, 3);
  uv_signal_start(&sterm, signal_cb, 15);
...
{
  signal_stop();
  uv_close((uv_handle_t *)&spipe, ((void*)0));
  uv_close((uv_handle_t *)&shup, ((void*)0));
  uv_close((uv_handle_t *)&squit, ((void*)0));
  uv_close((uv_handle_t *)&sterm, ((void*)0));
...
static void deadly_signal(int signum)
{
  ...
  __builtin___snprintf_chk ((char *)IObuff, sizeof(IObuff), 0, __builtin_object_size ((char *)IObuff, 2 > 1 ? 1 : 0), "Vim: Caught deadly signal '%s'\n", signal_name(signum));
...
{
  (__builtin_expect(!(signum >= 0), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/os/signal.c", 116, "signum >= 0") : (void)0);
  event_push((Event) {
...
static void on_signal_event(Event event)
{
  ...
  switch (signum) {
    ...
    case 1:
      ...
      break;
    default:
      fprintf(__stderrp, "Invalid signal %d", signum);
      break;
  }
}
