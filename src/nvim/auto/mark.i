...
# 44 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c" 2
# 58 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
static xfmark_T namedfm[(('z' - 'a' + 1) + ('9' - '0' + 1))];
# 67 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
int setmark(int c)
{
...
int setmark_pos(int c, pos_T *pos, int fnum)
{
  ...
  if (c == '"') {
    do { fmark_T *const fmarkp___ = &curbuf->b_last_cursor; free_fmark(*fmarkp___); do { fmark_T *const fmarkp__ = fmarkp___; fmarkp__->mark = *pos; fmarkp__->fnum = curbuf->b_fnum; fmarkp__->timestamp = os_time(); fmarkp__->additional_data = ((void*)0); } while (0); } while (0);
    return 1;
  }
  ...
  if (islower(c)) {
    i = c - 'a';
    do { fmark_T *const fmarkp___ = curbuf->b_namedm + i; free_fmark(*fmarkp___); do { fmark_T *const fmarkp__ = fmarkp___; fmarkp__->mark = *pos; fmarkp__->fnum = curbuf->b_fnum; fmarkp__->timestamp = os_time(); fmarkp__->additional_data = ((void*)0); } while (0); } while (0);
    return 1;
  }
  if (isupper(c)) {
    (__builtin_expect(!(c >= 'A' && c <= 'Z'), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 152, "c >= 'A' && c <= 'Z'") : (void)0);
    i = c - 'A';
...
void setpcmark(void)
{
  ...
  do { xfmark_T *const xfmarkp__ = fm; xfmarkp__->fname = ((void*)0); do { fmark_T *const fmarkp__ = &(xfmarkp__->fmark); fmarkp__->mark = curwin->w_pcmark; fmarkp__->fnum = curbuf->b_fnum; fmarkp__->timestamp = os_time(); fmarkp__->additional_data = ((void*)0); } while (0); } while (0);
}
...
# 293 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
...
)
{
  ...
  for (i = 0; i < ('z' - 'a' + 1); i++) {
    if (curbuf->b_namedm[i].mark.lnum > 0) {
      if (dir == 1) {
        if ((result == ((void*)0) || (((curbuf->b_namedm[i].mark).lnum != (*result).lnum) ? (curbuf->b_namedm[i].mark).lnum < (*result).lnum : (curbuf->b_namedm[i].mark).col != (*result).col ? (curbuf->b_namedm[i].mark).col < (*result).col : (curbuf->b_namedm[i].mark).coladd < (*result).coladd))
            && (((pos).lnum != (curbuf->b_namedm[i].mark).lnum) ? (pos).lnum < (curbuf->b_namedm[i].mark).lnum : (pos).col != (curbuf->b_namedm[i].mark).col ? (pos).col < (curbuf->b_namedm[i].mark).col : (pos).coladd < (curbuf->b_namedm[i].mark).coladd))
          result = &curbuf->b_namedm[i].mark;
      } else {
        if ((result == ((void*)0) || (((*result).lnum != (curbuf->b_namedm[i].mark).lnum) ? (*result).lnum < (curbuf->b_namedm[i].mark).lnum : (*result).col != (curbuf->b_namedm[i].mark).col ? (*result).col < (curbuf->b_namedm[i].mark).col : (*result).coladd < (curbuf->b_namedm[i].mark).coladd))
            && (((curbuf->b_namedm[i].mark).lnum != (pos).lnum) ? (curbuf->b_namedm[i].mark).lnum < (pos).lnum : (curbuf->b_namedm[i].mark).col != (pos).col ? (curbuf->b_namedm[i].mark).col < (pos).col : (curbuf->b_namedm[i].mark).coladd < (pos).coladd))
          result = &curbuf->b_namedm[i].mark;
      }
    }
  }
...
static char_u *mark_line(pos_T *mp, int lead_len)
{
  ...
  (__builtin_expect(!(Columns >= 0 && (size_t)Columns <= 18446744073709551615ULL), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 595, "Columns >= 0 && (size_t)Columns <= SIZE_MAX") : (void)0);
...
void ex_changes(exarg_T *eap)
{
  ...
  for (i = 0; i < curbuf->b_changelistlen && !got_int; ++i) {
    if (curbuf->b_changelist[i].mark.lnum != 0) {
      ...
      if (got_int)
        break;
      __builtin___sprintf_chk ((char *)IObuff, 0, __builtin_object_size ((char *)IObuff, 2 > 1 ? 1 : 0), "%c %3d %5ld %4d ", i == curwin->w_changelistidx ? '>' : ' ', i > curwin->w_changelistidx ? i - curwin->w_changelistidx : curwin->w_changelistidx - i, (long)curbuf->b_changelist[i].mark.lnum, curbuf->b_changelist[i].mark.col);
...
# 885 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
void mark_adjust(linenr_T line1, linenr_T line2, long amount, long amount_after)
{
  ...
  if (!cmdmod.lockmarks) {
    ...
    for (i = 0; i < ('z' - 'a' + 1); i++) {
      { lp = &(curbuf->b_namedm[i].mark.lnum); if (*lp >= line1 && *lp <= line2) { if (amount == 0x7fffffff) *lp = 0; else *lp += amount; } else if (amount_after && *lp > line2) *lp += amount_after; };
    ...
    { lp = &(curbuf->b_last_insert.mark.lnum); if (*lp >= line1 && *lp <= line2) { if (amount == 0x7fffffff) *lp = 0; else *lp += amount; } else if (amount_after && *lp > line2) *lp += amount_after; };


    { lp = &(curbuf->b_last_change.mark.lnum); if (*lp >= line1 && *lp <= line2) { if (amount == 0x7fffffff) *lp = 0; else *lp += amount; } else if (amount_after && *lp > line2) *lp += amount_after; };


    if (!(((curbuf->b_last_cursor.mark).lnum == (initpos).lnum) && ((curbuf->b_last_cursor.mark).col == (initpos).col) && ((curbuf->b_last_cursor.mark).coladd == (initpos).coladd)))
      { lp = &(curbuf->b_last_cursor.mark.lnum); if (*lp >= line1 && *lp <= line2) { if (amount == 0x7fffffff) *lp = 0; else *lp += amount; } else if (amount_after && *lp > line2) *lp += amount_after; };



    for (i = 0; i < curbuf->b_changelistlen; ++i)
      { lp = &(curbuf->b_changelist[i].mark.lnum); if (*lp >= line1 && *lp <= line2) { if (amount == 0x7fffffff) *lp = line1; else *lp += amount; } else if (amount_after && *lp > line2) *lp += amount_after; };
...
# 1039 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
void mark_col_adjust(linenr_T lnum, colnr_T mincol, long lnum_amount, long col_amount)
{
  ...
  for (i = 0; i < ('z' - 'a' + 1); i++) {
    { posp = &(curbuf->b_namedm[i].mark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1050, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };
    if (namedfm[i].fmark.fnum == fnum)
      { posp = &(namedfm[i].fmark.mark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1052, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };
  }
  for (i = ('z' - 'a' + 1); i < (('z' - 'a' + 1) + ('9' - '0' + 1)); i++) {
    if (namedfm[i].fmark.fnum == fnum)
      { posp = &(namedfm[i].fmark.mark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1056, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };
  }


  { posp = &(curbuf->b_last_insert.mark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1060, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };


  { posp = &(curbuf->b_last_change.mark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1063, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };


  for (i = 0; i < curbuf->b_changelistlen; ++i)
    { posp = &(curbuf->b_changelist[i].mark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1067, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };


  { posp = &(curbuf->b_visual.vi_start); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1070, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };
  ...
  { posp = &(curwin->w_pcmark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1074, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };


  { posp = &(curwin->w_prev_pcmark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1077, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };
  ...
  for (win_T *win = ((curtab) == curtab) ? firstwin : (curtab)->tp_firstwin; win != ((void*)0); win = win->w_next) {
    ...
    for (i = 0; i < win->w_jumplistlen; ++i) {
      if (win->w_jumplist[i].fmark.fnum == fnum) {
        { posp = &(win->w_jumplist[i].fmark.mark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1089, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };
      }
    }
    ...
    if (win->w_buffer == curbuf) {
      ...
      for (i = 0; i < win->w_tagstacklen; i++) {
        if (win->w_tagstack[i].fmark.fnum == fnum) {
          { posp = &(win->w_tagstack[i].fmark.mark); if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1097, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };
        }
      }


      if (win != curwin) {
        { posp = &win->w_cursor; if (posp->lnum == lnum && posp->col >= mincol) { posp->lnum += lnum_amount; (__builtin_expect(!(col_amount > (-2147483647 -1) && col_amount <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c", 1103, "col_amount > INT_MIN && col_amount <= INT_MAX") : (void)0); if (col_amount < 0 && posp->col <= (colnr_T)-col_amount) posp->col = 0; else posp->col += (colnr_T)col_amount; } };
      }
    }
  }
}
...
# 1173 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
...
# 1204 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
...
# 1244 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
...
# 1287 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
...
# 1327 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
...
# 1353 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.c"
