...
static inline JobOptions common_job_options(char **argv, ufunc_T *on_stdout, ufunc_T *on_stderr, ufunc_T *on_exit, dict_T *self);
...
static inline void push_job_event(Job *job, ufunc_T *callback, const char *type, char *data, size_t count, int status);
...
static void on_job_output(RStream *rstream, Job *job, RBuffer *buf, _Bool eof, ufunc_T *callback, const char *type);
