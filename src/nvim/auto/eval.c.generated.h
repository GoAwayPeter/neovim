...
static int string_convert_one_value(garray_T *const gap, MPConvStack *const mpstack, typval_T *const tv, const int copyID) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT;
static int echo_convert_one_value(garray_T *const gap, MPConvStack *const mpstack, typval_T *const tv, const int copyID) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT;
...
static int msgpack_convert_one_value(msgpack_packer *const packer, MPConvStack *const mpstack, typval_T *const tv, const int copyID) FUNC_ATTR_NONNULL_ALL FUNC_ATTR_WARN_UNUSED_RESULT;
...
static inline TerminalJobData *common_job_init(char **argv, ufunc_T *on_stdout, ufunc_T *on_stderr, ufunc_T *on_exit, dict_T *self, _Bool pty);
