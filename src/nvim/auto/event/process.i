# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 325 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
void *valloc(size_t);
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 13 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_eval.h" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/buffer_defs.h" 2
...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/iconv.h"
# 1 "/Users/George/Documents/Programs/C/neovim/config/auto/config.h" 1
# 15 "/Users/George/Documents/Programs/C/neovim/src/nvim/iconv.h" 2
...
# 1016 "/Users/George/Documents/Programs/C/neovim/src/nvim/globals.h"
...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c" 2
# 32 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c"
...
_Bool process_spawn(Process *proc) FUNC_ATTR_NONNULL_ALL
{
  ...
  if (proc->in) {
    stream_init(((void*)0), proc->in, -1, (uv_stream_t *)&proc->in->uv.pipe, data);
  ...
  if (proc->out) {
    stream_init(((void*)0), proc->out, -1, (uv_stream_t *)&proc->out->uv.pipe, data);
  ...
  if (proc->err) {
    stream_init(((void*)0), proc->err, -1, (uv_stream_t *)&proc->err->uv.pipe, data);
...
void process_teardown(Loop *loop) FUNC_ATTR_NONNULL_ALL
{
  ...
  for (kl1_WatcherPtr **current = ((void*)0) ? ((void*)0) : &loop->children->head; *current != loop->children->tail; current = &(*current)->next) {
    ...
    if (proc->detach) {
      ...
      do { if (loop->events) { queue_put_event((loop->events), event_create(1, (process_close_handles), 1, proc));; } else { void *argv[1] = {proc}; (process_close_handles)(argv); } } while (0);
    } else {
      if (proc->type == kProcessTypeUv) {
        uv_kill(proc->pid, 15);
        proc->term_sent = 1;
  ...
  do { int remaining = -1; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(((loop->children)->size == 0))) { do { if (loop->events && !queue_empty(loop->events)) { queue_process_events(loop->events); } else { loop_poll_events(loop, remaining); } } while (0); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
...
{
  do { if (proc->in && !proc->in->closed) { stream_close(proc->in, ((void*)0)); } } while (0);
}

void process_close_out(Process *proc) FUNC_ATTR_NONNULL_ALL
{
  do { if (proc->out && !proc->out->closed) { stream_close(proc->out, ((void*)0)); } } while (0);
}

void process_close_err(Process *proc) FUNC_ATTR_NONNULL_ALL
{
  do { if (proc->err && !proc->err->closed) { stream_close(proc->err, ((void*)0)); } } while (0);
}
# 172 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c"
int process_wait(Process *proc, int ms, Queue *events) FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  _Bool interrupted = 0;
  if (!proc->refcount) {
    do { if (proc->events && !queue_empty(proc->events)) { queue_process_events(proc->events); } else { loop_poll_events(proc->loop, 0); } } while (0);
    return proc->status;
  }
  ...
  proc->refcount++;
  do { int remaining = ms; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(got_int || proc->refcount == 1)) { do { if (events && !queue_empty(events)) { queue_process_events(events); } else { loop_poll_events(proc->loop, remaining); } } while (0); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
  ...
  if (got_int) {
    ...
    if (ms == -1) {
      ...
      do { int remaining = -1; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(proc->refcount == 1)) { do { if (events && !queue_empty(events)) { queue_process_events(events); } else { loop_poll_events(proc->loop, remaining); } } while (0); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);

    } else {
      do { if (events && !queue_empty(events)) { queue_process_events(events); } else { loop_poll_events(proc->loop, 0); } } while (0);
    }
  }
...
static void children_kill_cb(uv_timer_t *handle)
{
  ...
  for (kl1_WatcherPtr **current = ((void*)0) ? ((void*)0) : &loop->children->head; *current != loop->children->tail; current = &(*current)->next) {
    ...
    if (!proc->term_sent && elapsed >= 1000000000) {
      do_log(1, __func__, 274, 1, "Sending SIGTERM to pid %d", proc->pid);
      uv_kill(proc->pid, 15);
      proc->term_sent = 1;
    } else if (elapsed >= (1000000000 * 2)) {
      do_log(1, __func__, 278, 1, "Sending SIGKILL to pid %d", proc->pid);
      uv_kill(proc->pid, 9);
    }
  }
}
...
static void decref(Process *proc)
{
  ...
  (__builtin_expect(!(node), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c", 310, "node") : (void)0);
  kl_shift_at_WatcherPtr(loop->children, node);
  do { if (proc->events) { queue_put_event((proc->events), event_create(1, (process_close_event), 1, proc));; } else { void *argv[1] = {proc}; (process_close_event)(argv); } } while (0);
}
  ...
  FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  (__builtin_expect(!(!proc->closed), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/process.c", 322, "!proc->closed") : (void)0);
  proc->closed = 1;
  switch (proc->type) {
    case kProcessTypeUv:
...
static void on_process_exit(Process *proc)
{
  ...
  do { if (proc->events) { queue_put_event((proc->events), event_create(1, (process_close_handles), 1, proc));; } else { void *argv[1] = {proc}; (process_close_handles)(argv); } } while (0);
}
