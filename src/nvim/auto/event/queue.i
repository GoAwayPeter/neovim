# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
# 45 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c"
...
# 46 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
...
# 47 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
...
# 48 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
...
# 49 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
...
# 52 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
...
# 54 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
...
# 55 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
...
# 56 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c" 2
...
{
  return queue_new(((void*)0), put_cb, data);
}

Queue *queue_new_child(Queue *parent)
  FUNC_ATTR_NONNULL_ALL
{
  (__builtin_expect(!(!parent->parent), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 91, "!parent->parent") : (void)0);
  return queue_new(parent, ((void*)0), ((void*)0));
}

static Queue *queue_new(Queue *parent, put_callback put_cb, void *data)
{
  Queue *rv = xmalloc(sizeof(Queue));
  do { (*(QUEUE **) &((*(&rv->headtail))[0])) = (&rv->headtail); (*(QUEUE **) &((*(&rv->headtail))[1])) = (&rv->headtail); } while (0);
  rv->parent = parent;
  rv->put_cb = put_cb;
  rv->data = data;
  return rv;
...
{
  (__builtin_expect(!(queue), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 107, "queue") : (void)0);
  while (!((const QUEUE *) (&queue->headtail) == (const QUEUE *) (*(QUEUE **) &((*(&queue->headtail))[0])))) {
    QUEUE *q = ((*(QUEUE **) &((*(&queue->headtail))[0])));
    QueueItem *item = queue_node_data(q);
    if (queue->parent) {
      do { ((*(QUEUE **) &((*((*(QUEUE **) &((*(&item->data.item.parent->node))[1]))))[0]))) = (*(QUEUE **) &((*(&item->data.item.parent->node))[0])); ((*(QUEUE **) &((*((*(QUEUE **) &((*(&item->data.item.parent->node))[0]))))[1]))) = (*(QUEUE **) &((*(&item->data.item.parent->node))[1])); } while (0);
      xfree(item->data.item.parent);
    }
    do { ((*(QUEUE **) &((*((*(QUEUE **) &((*(q))[1]))))[0]))) = (*(QUEUE **) &((*(q))[0])); ((*(QUEUE **) &((*((*(QUEUE **) &((*(q))[0]))))[1]))) = (*(QUEUE **) &((*(q))[1])); } while (0);
    xfree(item);
  }
...
{
  (__builtin_expect(!(queue), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 129, "queue") : (void)0);
...
{
  (__builtin_expect(!(queue), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 138, "queue") : (void)0);
...
{
  (__builtin_expect(!(queue), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 149, "queue") : (void)0);
  return ((const QUEUE *) (&queue->headtail) == (const QUEUE *) (*(QUEUE **) &((*(&queue->headtail))[0])));
}

void queue_replace_parent(Queue *queue, Queue *new_parent)
{
  (__builtin_expect(!(queue_empty(queue)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 155, "queue_empty(queue)") : (void)0);
  queue->parent = new_parent;
}

static Event queue_remove(Queue *queue)
{
  (__builtin_expect(!(!queue_empty(queue)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 161, "!queue_empty(queue)") : (void)0);
  QUEUE *h = ((*(QUEUE **) &((*(&queue->headtail))[0])));
  do { ((*(QUEUE **) &((*((*(QUEUE **) &((*(h))[1]))))[0]))) = (*(QUEUE **) &((*(h))[0])); ((*(QUEUE **) &((*((*(QUEUE **) &((*(h))[0]))))[1]))) = (*(QUEUE **) &((*(h))[1])); } while (0);
  QueueItem *item = queue_node_data(h);
  Event rv;

  if (item->link) {
    (__builtin_expect(!(!queue->parent), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 168, "!queue->parent") : (void)0);

    Queue *linked = item->data.queue;
    (__builtin_expect(!(!queue_empty(linked)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/event/queue.c", 171, "!queue_empty(linked)") : (void)0);
    QueueItem *child =
      queue_node_data(((*(QUEUE **) &((*(&linked->headtail))[0]))));
    do { ((*(QUEUE **) &((*((*(QUEUE **) &((*(&child->node))[1]))))[0]))) = (*(QUEUE **) &((*(&child->node))[0])); ((*(QUEUE **) &((*((*(QUEUE **) &((*(&child->node))[0]))))[1]))) = (*(QUEUE **) &((*(&child->node))[1])); } while (0);
...
static void queue_push(Queue *queue, Event event)
{
  ...
  do { (*(QUEUE **) &((*(&item->node))[0])) = (&queue->headtail); (*(QUEUE **) &((*(&item->node))[1])) = (*(QUEUE **) &((*(&queue->headtail))[1])); ((*(QUEUE **) &((*((*(QUEUE **) &((*(&item->node))[1]))))[0]))) = (&item->node); (*(QUEUE **) &((*(&queue->headtail))[1])) = (&item->node); } while (0);
  if (queue->parent) {

    item->data.item.parent = xmalloc(sizeof(QueueItem));
    item->data.item.parent->link = 1;
    item->data.item.parent->data.queue = queue;
    do { (*(QUEUE **) &((*(&item->data.item.parent->node))[0])) = (&queue->parent->headtail); (*(QUEUE **) &((*(&item->data.item.parent->node))[1])) = (*(QUEUE **) &((*(&queue->parent->headtail))[1])); ((*(QUEUE **) &((*((*(QUEUE **) &((*(&item->data.item.parent->node))[1]))))[0]))) = (&item->data.item.parent->node); (*(QUEUE **) &((*(&queue->parent->headtail))[1])) = (&item->data.item.parent->node); } while (0);
  }
}

static QueueItem *queue_node_data(QUEUE *q)
{
  return ((QueueItem *) ((char *) (q) - ((char *) &((QueueItem *) 0)->node)));
}
