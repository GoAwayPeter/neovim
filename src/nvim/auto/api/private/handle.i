# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c" 2
...
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c" 2
...
# 133 "/Users/George/Documents/Programs/C/neovim/src/nvim/lib/khash.h"
...
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c" 2
# 30 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c"
static uint64_t next_handle = 1;

static Map_uint64_t_ptr_t * buffer_handles = ((void*)0); buf_T *handle_get_buffer(uint64_t handle) { return map_uint64_t_ptr_t_get( buffer_handles, handle); } void handle_register_buffer(buf_T *buffer) { (__builtin_expect(!(!buffer->handle), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c", 32, "!buffer->handle") : (void)0); buffer->handle = next_handle++; map_uint64_t_ptr_t_put( buffer_handles, buffer->handle, buffer); } void handle_unregister_buffer(buf_T *buffer) { map_uint64_t_ptr_t_del( buffer_handles, buffer->handle); }
static Map_uint64_t_ptr_t * window_handles = ((void*)0); win_T *handle_get_window(uint64_t handle) { return map_uint64_t_ptr_t_get( window_handles, handle); } void handle_register_window(win_T *window) { (__builtin_expect(!(!window->handle), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c", 33, "!window->handle") : (void)0); window->handle = next_handle++; map_uint64_t_ptr_t_put( window_handles, window->handle, window); } void handle_unregister_window(win_T *window) { map_uint64_t_ptr_t_del( window_handles, window->handle); }
static Map_uint64_t_ptr_t * tabpage_handles = ((void*)0); tabpage_T *handle_get_tabpage(uint64_t handle) { return map_uint64_t_ptr_t_get( tabpage_handles, handle); } void handle_register_tabpage(tabpage_T *tabpage) { (__builtin_expect(!(!tabpage->handle), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.c", 34, "!tabpage->handle") : (void)0); tabpage->handle = next_handle++; map_uint64_t_ptr_t_put( tabpage_handles, tabpage->handle, tabpage); } void handle_unregister_tabpage(tabpage_T *tabpage) { map_uint64_t_ptr_t_del( tabpage_handles, tabpage->handle); }

void handle_init(void)
{
  buffer_handles = map_uint64_t_ptr_t_new();
  window_handles = map_uint64_t_ptr_t_new();
  tabpage_handles = map_uint64_t_ptr_t_new();
}
