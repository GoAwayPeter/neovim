# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
wcstoumax(const wchar_t * restrict __nptr,
   wchar_t ** restrict __endptr,
   int __base);
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
void *valloc(size_t);
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.h" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.h" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.h" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.h" 1
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/handle.h"
buf_T *handle_get_buffer(uint64_t handle); void handle_register_buffer(buf_T *buffer); void handle_unregister_buffer(buf_T *buffer);
win_T *handle_get_window(uint64_t handle); void handle_register_window(win_T *window); void handle_unregister_window(win_T *window);
tabpage_T *handle_get_tabpage(uint64_t handle); void handle_register_tabpage(tabpage_T *tabpage); void handle_unregister_tabpage(tabpage_T *tabpage);

void handle_init(void);
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 13 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 16 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 396 "/Users/George/Documents/Programs/C/neovim/src/nvim/lib/khash.h"
...
# 413 "/Users/George/Documents/Programs/C/neovim/src/nvim/lib/khash.h"
...
# 612 "/Users/George/Documents/Programs/C/neovim/src/nvim/lib/khash.h"
typedef const char *kh_cstr_t;
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/map_defs.h" 2

typedef const char * cstr_t;
typedef void * ptr_t;
# 17 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c" 2
...
# 39 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/defs.h"
...
_Bool try_end(Error *err)
{
  ...
  if (got_int) {
    ...
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Keyboard interrupt"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
    got_int = 0;
    ...
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), "%s", current_exception->value); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
    discard_current_exception();
  }
...
Object dict_get_value(dict_T *dict, String key, Error *err)
{
  ...
  if (((hi)->hi_key == ((void*)0) || (hi)->hi_key == &hash_removed)) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Key not found"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
...
# 100 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c"
Object dict_set_value(dict_T *dict, String key, Object value, Error *err)
{
  Object rv = { .type = kObjectTypeNil };

  if (dict->dv_lock) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Dictionary is locked"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
    return rv;
  }

  if (key.size == 0) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Empty dictionary keys aren't allowed"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return rv;
  }

  if (key.size > 2147483647) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Key length is too high"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return rv;
  }
  ...
  if (value.type == kObjectTypeNil) {
    ...
    if (di == ((void*)0)) {
      ...
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Key \"%s\" doesn't exist")), key.data); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    } else {
...
# 170 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c"
Object get_option_from(void *from, int type, String name, Error *err)
{
  Object rv = { .type = kObjectTypeNil };

  if (name.size == 0) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Empty option name"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return rv;
  }
  ...
  if (!flags) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Invalid option name \"%s\"")), name.data); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
  ...
  if (flags & 0x01) {
    ...
    if (stringval) {
      ...
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Unable to get value for option \"%s\"")), name.data); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);



    }
  } else {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Unknown type for option \"%s\"")), name.data); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
...
# 227 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c"
void set_option_to(void *to, int type, String name, Object value, Error *err)
{
  ...
  if (value.type == kObjectTypeNil) {
    if (type == 0) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Unable to unset option \"%s\"")), name.data); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);



      return;
    } else if (!(flags & 0x08)) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Cannot unset option \"%s\" " "because it doesn't have a global value")), name.data); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
  ...
  int opt_flags = (type ? 4 : 2);

  if (flags & 0x01) {
    if (value.type != kObjectTypeBoolean) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Option \"%s\" requires a boolean value")), name.data); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    ...
    _Bool val = value.data.boolean;
    set_option_value_for(name.data, val, ((void*)0), opt_flags, type, to, err);
  } else if (flags & 0x02) {
    if (value.type != kObjectTypeInteger) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Option \"%s\" requires an integer value")), name.data); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    ...
    if (value.data.integer > 2147483647 || value.data.integer < (-2147483647 -1)) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Value for option \"%s\" is outside range")), name.data); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    ...
    if (value.type != kObjectTypeString) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Option \"%s\" requires a string value")), name.data); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
...
Object vim_to_object(typval_T *obj)
{
  ...
  Map_ptr_t_ptr_t *lookup = map_ptr_t_ptr_t_new();
  rv = vim_to_object_rec(obj, lookup);

  map_ptr_t_ptr_t_free(lookup);
  return rv;
}
...
buf_T *find_buffer_by_handle(Buffer buffer, Error *err)
{
  ...
  if (!rv) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Invalid buffer id"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
  }
...
win_T * find_window_by_handle(Window window, Error *err)
{
  ...
  if (!rv) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Invalid window id"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
  }
...
tabpage_T * find_tab_by_handle(Tabpage tabpage, Error *err)
{
  ...
  if (!rv) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Invalid tabpage id"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
  }

  return rv;
}
# 366 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c"
...
_Bool object_to_vim(Object obj, typval_T *tv, Error *err)
{
  ...
  switch (obj.type) {
    ...
    case kObjectTypeInteger:
      if (obj.data.integer > 2147483647 || obj.data.integer < (-2147483647 -1)) {
        do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Integer value outside range"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
        return 0;
      }
...
static void init_error_type_metadata(Dictionary *metadata)
{
  ...
  do { if ((exception_metadata).size == (exception_metadata).capacity) { (exception_metadata).capacity = (exception_metadata).capacity? (exception_metadata).capacity<<1 : 8; (exception_metadata).items = (KeyValuePair*)xrealloc((exception_metadata).items, sizeof(KeyValuePair) * (exception_metadata).capacity); } (exception_metadata).items[(exception_metadata).size++] = (((KeyValuePair) {.key = cstr_to_string("id"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = kErrorTypeException })})); } while (0);

  Dictionary validation_metadata = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((validation_metadata).size == (validation_metadata).capacity) { (validation_metadata).capacity = (validation_metadata).capacity? (validation_metadata).capacity<<1 : 8; (validation_metadata).items = (KeyValuePair*)xrealloc((validation_metadata).items, sizeof(KeyValuePair) * (validation_metadata).capacity); } (validation_metadata).items[(validation_metadata).size++] = (((KeyValuePair) {.key = cstr_to_string("id"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = kErrorTypeValidation })})); } while (0);

  do { if ((types).size == (types).capacity) { (types).capacity = (types).capacity? (types).capacity<<1 : 8; (types).items = (KeyValuePair*)xrealloc((types).items, sizeof(KeyValuePair) * (types).capacity); } (types).items[(types).size++] = (((KeyValuePair) {.key = cstr_to_string("Exception"), .value = ((Object) { .type = kObjectTypeDictionary, .data.dictionary = exception_metadata })})); } while (0);
  do { if ((types).size == (types).capacity) { (types).capacity = (types).capacity? (types).capacity<<1 : 8; (types).items = (KeyValuePair*)xrealloc((types).items, sizeof(KeyValuePair) * (types).capacity); } (types).items[(types).size++] = (((KeyValuePair) {.key = cstr_to_string("Validation"), .value = ((Object) { .type = kObjectTypeDictionary, .data.dictionary = validation_metadata })})); } while (0);

  do { if ((*metadata).size == (*metadata).capacity) { (*metadata).capacity = (*metadata).capacity? (*metadata).capacity<<1 : 8; (*metadata).items = (KeyValuePair*)xrealloc((*metadata).items, sizeof(KeyValuePair) * (*metadata).capacity); } (*metadata).items[(*metadata).size++] = (((KeyValuePair) {.key = cstr_to_string("error_types"), .value = ((Object) { .type = kObjectTypeDictionary, .data.dictionary = types })})); } while (0);
}
static void init_type_metadata(Dictionary *metadata)
{
  ...
  do { if ((buffer_metadata).size == (buffer_metadata).capacity) { (buffer_metadata).capacity = (buffer_metadata).capacity? (buffer_metadata).capacity<<1 : 8; (buffer_metadata).items = (KeyValuePair*)xrealloc((buffer_metadata).items, sizeof(KeyValuePair) * (buffer_metadata).capacity); } (buffer_metadata).items[(buffer_metadata).size++] = (((KeyValuePair) {.key = cstr_to_string("id"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = kObjectTypeBuffer })})); } while (0);

  Dictionary window_metadata = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((window_metadata).size == (window_metadata).capacity) { (window_metadata).capacity = (window_metadata).capacity? (window_metadata).capacity<<1 : 8; (window_metadata).items = (KeyValuePair*)xrealloc((window_metadata).items, sizeof(KeyValuePair) * (window_metadata).capacity); } (window_metadata).items[(window_metadata).size++] = (((KeyValuePair) {.key = cstr_to_string("id"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = kObjectTypeWindow })})); } while (0);

  Dictionary tabpage_metadata = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((tabpage_metadata).size == (tabpage_metadata).capacity) { (tabpage_metadata).capacity = (tabpage_metadata).capacity? (tabpage_metadata).capacity<<1 : 8; (tabpage_metadata).items = (KeyValuePair*)xrealloc((tabpage_metadata).items, sizeof(KeyValuePair) * (tabpage_metadata).capacity); } (tabpage_metadata).items[(tabpage_metadata).size++] = (((KeyValuePair) {.key = cstr_to_string("id"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = kObjectTypeTabpage })})); } while (0);

  do { if ((types).size == (types).capacity) { (types).capacity = (types).capacity? (types).capacity<<1 : 8; (types).items = (KeyValuePair*)xrealloc((types).items, sizeof(KeyValuePair) * (types).capacity); } (types).items[(types).size++] = (((KeyValuePair) {.key = cstr_to_string("Buffer"), .value = ((Object) { .type = kObjectTypeDictionary, .data.dictionary = buffer_metadata })})); } while (0);
  do { if ((types).size == (types).capacity) { (types).capacity = (types).capacity? (types).capacity<<1 : 8; (types).items = (KeyValuePair*)xrealloc((types).items, sizeof(KeyValuePair) * (types).capacity); } (types).items[(types).size++] = (((KeyValuePair) {.key = cstr_to_string("Window"), .value = ((Object) { .type = kObjectTypeDictionary, .data.dictionary = window_metadata })})); } while (0);
  do { if ((types).size == (types).capacity) { (types).capacity = (types).capacity? (types).capacity<<1 : 8; (types).items = (KeyValuePair*)xrealloc((types).items, sizeof(KeyValuePair) * (types).capacity); } (types).items[(types).size++] = (((KeyValuePair) {.key = cstr_to_string("Tabpage"), .value = ((Object) { .type = kObjectTypeDictionary, .data.dictionary = tabpage_metadata })})); } while (0);

  do { if ((*metadata).size == (*metadata).capacity) { (*metadata).capacity = (*metadata).capacity? (*metadata).capacity<<1 : 8; (*metadata).items = (KeyValuePair*)xrealloc((*metadata).items, sizeof(KeyValuePair) * (*metadata).capacity); } (*metadata).items[(*metadata).size++] = (((KeyValuePair) {.key = cstr_to_string("types"), .value = ((Object) { .type = kObjectTypeDictionary, .data.dictionary = types })})); } while (0);
}
...
static Object copy_object(Object obj)
{
  switch (obj.type) {
    ...
    case kObjectTypeString:
      return ((Object) { .type = kObjectTypeString, .data.string = cstr_to_string(obj.data.string.data) });

    case kObjectTypeArray: {
      Array rv = {.size = 0, .capacity = 0, .items = ((void*)0)};
      for (size_t i = 0; i < obj.data.array.size; i++) {
        do { if ((rv).size == (rv).capacity) { (rv).capacity = (rv).capacity? (rv).capacity<<1 : 8; (rv).items = (Object*)xrealloc((rv).items, sizeof(Object) * (rv).capacity); } (rv).items[(rv).size++] = (copy_object(obj.data.array.items[i])); } while (0);
      }
      return ((Object) { .type = kObjectTypeArray, .data.array = rv });
    }
    ...
    case kObjectTypeDictionary: {
      ...
      for (size_t i = 0; i < obj.data.dictionary.size; i++) {
        KeyValuePair item = obj.data.dictionary.items[i];
        do { if ((rv).size == (rv).capacity) { (rv).capacity = (rv).capacity? (rv).capacity<<1 : 8; (rv).items = (KeyValuePair*)xrealloc((rv).items, sizeof(KeyValuePair) * (rv).capacity); } (rv).items[(rv).size++] = (((KeyValuePair) {.key = cstr_to_string(item.key.data), .value = copy_object(item.value)})); } while (0);
      }
      return ((Object) { .type = kObjectTypeDictionary, .data.dictionary = rv });
    }
    default:
      abort();
  }
...
static Object vim_to_object_rec(typval_T *obj, Map_ptr_t_ptr_t *lookup)
{
  ...
  if (obj->v_type == 4 || obj->v_type == 5) {

    if (map_ptr_t_ptr_t_has(lookup, obj)) {


      return rv;
    }
    map_ptr_t_ptr_t_put(lookup, obj, ((void*)0));
  }
    ...
    case 4:
      {
        ...
        if (list != ((void*)0)) {
          ...
          (__builtin_expect(!(list->lv_len >= 0), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/helpers.c", 676, "list->lv_len >= 0") : (void)0);
          rv.data.array.size = (size_t)list->lv_len;
          rv.data.array.items = xmalloc(rv.data.array.size * sizeof(Object));

          uint32_t i = 0;
          for (item = list->lv_first; item != ((void*)0); item = item->li_next) {
  ...
  switch (opt_type)
  {
    case 1:
            ...
            win_find_tabpage((win_T *)from), 0) == 0)
      {
        ...
        do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Problem while switching windows"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
                                 ...
                                 Error *err)
{
                                         ...
                                         opt_flags)))
  {
    ...
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), "%s", errmsg); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
  }
}
