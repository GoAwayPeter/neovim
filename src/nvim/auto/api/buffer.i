# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
void *valloc(size_t);
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/private/defs.h" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.h" 2
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 15 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/memline.h" 1
# 16 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/misc1.h" 1
# 18 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_cmds.h" 1
# 20 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/mark.h" 1
# 21 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
...
# 22 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/move.h" 1
# 23 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/undo.h" 1
# 25 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c" 2
# 35 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c"
...
{
  String rv = {.size = 0};
  Array slice = buffer_get_line_slice(buffer, index, index, 1, 1, err);
  ...
  FUNC_ATTR_DEFERRED
{
  ...
  buffer_set_line_slice(buffer, index, index, 1, 1, array, err);
}
...
# 101 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c"
                                 ...
                                 Error *err)
{
  ...
  for (size_t i = 0; i < rv.size; i++) {
    ...
    if (lnum > 9223372036854775807L) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Line index is too high"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
      goto end;
    }
...
# 167 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c"
  ...
  FUNC_ATTR_DEFERRED
{
  ...
  if (!inbounds(buf, start)) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Index out of bounds"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return;
  }
  ...
  if (start > end) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Argument \"start\" is higher than \"end\""))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
  ...
  for (size_t i = 0; i < new_len; i++) {
    if (replacement.items[i].type != kObjectTypeString) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("All items in the replacement array must be strings"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    ...
    for (size_t j = 0; j < l.size; j++) {
      if (l.data[j] == '\n') {
        do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("string cannot contain newlines"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
        new_len = i + 1;
        goto end;
      }
  ...
  if (u_save((linenr_T)(start - 1), (linenr_T)end) == 0) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Failed to save undo information"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
    goto end;
  }
  ...
  for (size_t i = 0; i < to_delete; i++) {
    if (ml_delete((linenr_T)start, 0) == 0) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Failed to delete line"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
      goto end;
    }
  }
  ...
  for (size_t i = 0; i < to_replace; i++) {
    ...
    if (lnum > 9223372036854775807L) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Index value is too high"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
      goto end;
    }

    if (ml_replace((linenr_T)lnum, (char_u *)lines[i], 0) == 0) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Failed to replace line"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
      goto end;
    }
  ...
  for (size_t i = to_replace; i < new_len; i++) {
    ...
    if (ml_append((linenr_T)lnum, (char_u *)lines[i], 0, 0) == 0) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Failed to insert line"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
      goto end;
    }
  ...
  if (save_curbuf == ((void*)0)) {
    mark_adjust((linenr_T)start, (linenr_T)(end - 1), 0x7fffffff, extra);
  }
...
# 341 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c"
...
# 377 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c"
  ...
  FUNC_ATTR_DEFERRED
{
  ...
  set_option_to(buf, 2, name, value, err);
}
  ...
  FUNC_ATTR_DEFERRED
{
  ...
  if (ren_ret == 0) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Failed to rename buffer"))); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
  }
}
...
{
  Error stub = { .set = 0 };
  return find_buffer_by_handle(buffer, &stub) != ((void*)0);
}
# 471 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/buffer.c"
void buffer_insert(Buffer buffer,
  ...
  FUNC_ATTR_DEFERRED
{
  buffer_set_line_slice(buffer, lnum, lnum, 0, 1, lines, err);
}
...
ArrayOf(Integer, 2) buffer_get_mark(Buffer buffer, String name, Error *err)
{
  ...
  if (name.size != 1) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Mark name must be a single character"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return rv;
  }
  ...
  if (posp == ((void*)0)) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Invalid mark name"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return rv;
  }

  do { if ((rv).size == (rv).capacity) { (rv).capacity = (rv).capacity? (rv).capacity<<1 : 8; (rv).items = (Object*)xrealloc((rv).items, sizeof(Object) * (rv).capacity); } (rv).items[(rv).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = posp->lnum })); } while (0);
  do { if ((rv).size == (rv).capacity) { (rv).capacity = (rv).capacity? (rv).capacity<<1 : 8; (rv).items = (Object*)xrealloc((rv).items, sizeof(Object) * (rv).capacity); } (rv).items[(rv).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = posp->col })); } while (0);
