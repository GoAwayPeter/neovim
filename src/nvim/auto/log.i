...
FILE *open_log_file(void)
{
  ...
  if (opening_log_file) {
    do_log_to_file(__stderrp, 3, __func__, 71, 1,
...
open_log_file_error:
  ...
  do_log_to_file(__stderrp, 3, __func__, 101, 1,
                             ...
                             const char* fmt, va_list args)
{
  ...
  (__builtin_expect(!(log_level >= 0 && log_level <= 3), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/log.c", 131, "log_level >= DEBUG_LOG_LEVEL && log_level <= ERROR_LOG_LEVEL") : (void)0);
