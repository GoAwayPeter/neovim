# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
...
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
...
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
...
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
...
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
...
# 13 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c" 2
# 28 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.c"
...
static void ui_bridge_stop(UI *b)
{
  ...
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_stop_event, 1, b), (((UIBridgeData *)b)->ui));
  for (;;) {
    uv_mutex_lock(&bridge->mutex);
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_resize_event, 3, b, ((void *)(uintptr_t)width), ((void *)(uintptr_t)height)), (((UIBridgeData *)b)->ui));
}
static void ui_bridge_resize_event(void **argv)
{
  UI *ui = (((UIBridgeData *)argv[0])->ui);
  ui->resize(ui, ((int)(uintptr_t)argv[1]), ((int)(uintptr_t)argv[2]));
}

static void ui_bridge_clear(UI *b)
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_clear_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_eol_clear_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_cursor_goto_event, 3, b, ((void *)(uintptr_t)row), ((void *)(uintptr_t)col)), (((UIBridgeData *)b)->ui));
}
static void ui_bridge_cursor_goto_event(void **argv)
{
  UI *ui = (((UIBridgeData *)argv[0])->ui);
  ui->cursor_goto(ui, ((int)(uintptr_t)argv[1]), ((int)(uintptr_t)argv[2]));
}

static void ui_bridge_update_menu(UI *b)
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_update_menu_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_busy_start_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_busy_stop_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_mouse_on_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_mouse_off_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_mode_change_event, 2, b, ((void *)(uintptr_t)mode)), (((UIBridgeData *)b)->ui));
}
static void ui_bridge_mode_change_event(void **argv)
{
  UI *ui = (((UIBridgeData *)argv[0])->ui);
  ui->mode_change(ui, ((int)(uintptr_t)argv[1]));
}

static void ui_bridge_set_scroll_region(UI *b, int top, int bot, int left,
    int right)
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_set_scroll_region_event, 5, b, ((void *)(uintptr_t)top), ((void *)(uintptr_t)bot), ((void *)(uintptr_t)left), ((void *)(uintptr_t)right)), (((UIBridgeData *)b)->ui));

}
static void ui_bridge_set_scroll_region_event(void **argv)
{
  UI *ui = (((UIBridgeData *)argv[0])->ui);
  ui->set_scroll_region(ui, ((int)(uintptr_t)argv[1]), ((int)(uintptr_t)argv[2]),
      ((int)(uintptr_t)argv[3]), ((int)(uintptr_t)argv[4]));
}

static void ui_bridge_scroll(UI *b, int count)
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_scroll_event, 2, b, ((void *)(uintptr_t)count)), (((UIBridgeData *)b)->ui));
}
static void ui_bridge_scroll_event(void **argv)
{
  UI *ui = (((UIBridgeData *)argv[0])->ui);
  ui->scroll(ui, ((int)(uintptr_t)argv[1]));
}
...
static void ui_bridge_highlight_set(UI *b, HlAttrs attrs)
{
  ...
  *a = attrs;
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_highlight_set_event, 2, b, a), (((UIBridgeData *)b)->ui));
}
...
static void ui_bridge_put(UI *b, uint8_t *text, size_t size)
{
  ...
  if (text) {
    ...
    __builtin___memcpy_chk (t, text, size, __builtin_object_size (t, 0));
  }
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_put_event, 3, b, t, ((void *)(uintptr_t)size)), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_bell_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_visual_bell_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_update_fg_event, 2, b, ((void *)(uintptr_t)fg)), (((UIBridgeData *)b)->ui));
}
static void ui_bridge_update_fg_event(void **argv)
{
  UI *ui = (((UIBridgeData *)argv[0])->ui);
  ui->update_fg(ui, ((int)(uintptr_t)argv[1]));
}

static void ui_bridge_update_bg(UI *b, int bg)
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_update_bg_event, 2, b, ((void *)(uintptr_t)bg)), (((UIBridgeData *)b)->ui));
}
static void ui_bridge_update_bg_event(void **argv)
{
  UI *ui = (((UIBridgeData *)argv[0])->ui);
  ui->update_bg(ui, ((int)(uintptr_t)argv[1]));
}

static void ui_bridge_flush(UI *b)
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_flush_event, 1, b), (((UIBridgeData *)b)->ui));
}
...
static void ui_bridge_suspend(UI *b)
{
  ...
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_suspend_event, 1, b), (((UIBridgeData *)b)->ui));
  data->ready = 0;
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_set_title_event, 2, b, title ? xstrdup(title) : ((void*)0)), (((UIBridgeData *)b)->ui));
}
...
{
  ((UIBridgeData *)b)->scheduler( event_create(1, ui_bridge_set_icon_event, 2, b, icon ? xstrdup(icon) : ((void*)0)), (((UIBridgeData *)b)->ui));
}
