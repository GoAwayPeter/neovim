...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
...
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
...
# 20 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/input.h" 1
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/input.h" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/input.h" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/time.h" 1
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/input.h" 2
...
# 21 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.h" 1
# 22 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
...
# 23 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/strings.h" 1
# 24 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ugrid.h" 1
...
# 25 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.h" 1
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/ui_bridge.h"
...
# 26 "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c" 2
...
{
  TUIData *data = ui->data;
  data->print_attrs = ((HlAttrs){0, 0, 0, 0, 0, -1, -1});
...
static void clear_region(UI *ui, int top, int bot, int left, int right)
{
  ...
  if (!cleared) {
    ...
    int currow = -1;
    do { for (int row = top; row <= bot; ++row) { UCell *row_cells = (grid)->cells[row]; for (int col = left; col <= right; ++col) { UCell *cell = row_cells + col; (void)(cell); { if (currow != row) { unibi_goto(ui, row, col); currow = row; } print_cell(ui, cell); }; } } } while (0);
...
static void tui_resize(UI *ui, int width, int height)
{
  ...
  if (!got_winch) {
    char r[16];
    __builtin___snprintf_chk (r, sizeof(r), 0, __builtin_object_size (r, 2 > 1 ? 1 : 0), "\x1b[8;%d;%dt", height, width);
    out(ui, r, strlen(r));
  } else {
    got_winch = 0;
  }
...
static void tui_mode_change(UI *ui, int mode)
{
  ...
  if (mode == 0x10) {
    if (data->showing_mode != 0x10) {
      unibi_out(ui, data->unibi_ext.enter_insert_mode);
    }
  } else if (mode == (0x40 + 0x10)) {
    if (data->showing_mode != (0x40 + 0x10)) {
      unibi_out(ui, data->unibi_ext.enter_replace_mode);
    }
  } else {
    (__builtin_expect(!(mode == 0x01), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c", 465, "mode == NORMAL") : (void)0);
    if (data->showing_mode != 0x01) {
...
static void tui_flush(UI *ui)
{
  ...
  while (((data->invalid_regions).size)) {
    ...
    int currow = -1;
    do { for (int row = r.top; row <= r.bot; ++row) { UCell *row_cells = (grid)->cells[row]; for (int col = r.left; col <= r.right; ++col) { UCell *cell = row_cells + col; (void)(cell); { if (currow != row) { unibi_goto(ui, row, col); currow = row; } print_cell(ui, cell); }; } } } while (0);
...
static void update_size(UI *ui)
{
  ...
  if (starting != 0 && (Columns != 80 || Rows != 24)) {
    (__builtin_expect(!(Columns >= (-2147483647 -1) && Columns <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c", 689, "Columns >= INT_MIN && Columns <= INT_MAX") : (void)0);
    (__builtin_expect(!(Rows >= (-2147483647 -1) && Rows <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/tui/tui.c", 690, "Rows >= INT_MIN && Rows <= INT_MAX") : (void)0);
    width = (int)Columns;
    height = (int)Rows;
    goto end;
  }
...
static void fix_terminfo(TUIData *data)
{
  ...
  } else if ((!memcmp(term, "screen", sizeof("screen") - 1)) || (!memcmp(term, "tmux", sizeof("tmux") - 1))) {
  ...
  data->unibi_ext.enable_focus_reporting = (int)unibi_add_ext_str(ut, ((void*)0),
      "\x1b[?1004h");
  data->unibi_ext.disable_focus_reporting = (int)unibi_add_ext_str(ut, ((void*)0),
      "\x1b[?1004l");
  ...
  if ((term_prog && !strcmp(term_prog, "Konsole"))
      || os_getenv("KONSOLE_DBUS_SESSION") != ((void*)0)) {
    ...
    data->unibi_ext.enter_replace_mode = (int)unibi_add_ext_str(ut, ((void*)0),
        (inside_tmux ? "\x1bPtmux;\x1b" "\x1b]50;CursorShape=2;BlinkingCursorEnabled=1\x07" "\x1b\\" : "\x1b]50;CursorShape=2;BlinkingCursorEnabled=1\x07"));
    ...
    data->unibi_ext.enter_replace_mode = (int)unibi_add_ext_str(ut, ((void*)0),
        (inside_tmux ? "\x1bPtmux;\x1b" "\x1b[3 q" "\x1b\\" : "\x1b[3 q"));
    data->unibi_ext.exit_insert_mode = (int)unibi_add_ext_str(ut, ((void*)0),
