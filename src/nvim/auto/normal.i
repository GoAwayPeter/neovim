...
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/state.h" 1



# 1 "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/../lib/clang/7.0.0/include/stddef.h" 1 3 4
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/state.h" 2
...
# 68 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c" 2

typedef struct normal_state {
  VimState state;
  linenr_T conceal_old_cursor_line;
  linenr_T conceal_new_cursor_line;
  _Bool command_finished;
  _Bool ctrl_w;
  _Bool need_flushbuf;
  _Bool conceal_update_lines;
  _Bool set_prevcount;
  _Bool previous_got_int;
  _Bool cmdwin;
  _Bool noexmode;
...
{
  __builtin___memset_chk (s, 0, sizeof(NormalState), __builtin_object_size (s, 0));
...
# 157 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
} nv_cmds[] =
{
  ...
  {(-((253) + ((int)(KE_FOCUSGAINED) << 8))), nv_focusgained, 0x100, 0},
  {(-((253) + ((int)(KE_FOCUSLOST) << 8))), nv_focuslost, 0x100, 0},
};
...
{
  (__builtin_expect(!(((sizeof(nv_cmds)/sizeof((nv_cmds)[0])) / ((size_t)(!(sizeof(nv_cmds) % sizeof((nv_cmds)[0]))))) <= 32767), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 389, "NV_CMDS_SIZE <= SHRT_MAX") : (void)0);
...
static int find_command(int cmdchar)
{
  ...
  (__builtin_expect(!(nv_max_linear < (int)((sizeof(nv_cmds)/sizeof((nv_cmds)[0])) / ((size_t)(!(sizeof(nv_cmds) % sizeof((nv_cmds)[0])))))), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 431, "nv_max_linear < (int)NV_CMDS_SIZE") : (void)0);
...
# 465 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
{
  __builtin___memset_chk (&s->ca, 0, sizeof(s->ca), __builtin_object_size (&s->ca, 0));
  s->ca.oap = &s->oa;
...
static _Bool normal_need_aditional_char(NormalState *s)
{
  ...
  _Bool pending_op = s->oa.op_type != 0;
...
# 574 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
static void normal_get_additional_char(NormalState *s)
{
  ...
  if (s->ca.cmdchar == 'g') {
    ...
    do { if (*p_langmap && (1) && (!p_lnr || (p_lnr && typebuf_maplen() == 0)) && !KeyStuffed && (s->ca.nchar) >= 0) { if ((s->ca.nchar) < 256) s->ca.nchar = langmap_mapchar[s->ca.nchar]; else s->ca.nchar = langmap_adjust_mb(s->ca.nchar); } } while (0);
  ...
  if (cp != ((void*)0)) {
    ...
    *cp = plain_vgetc();
    ...
    if (cp == &s->ca.extra_char
      ...
      if (s->c > 0) {
        ...
        if (s->c != 14 && s->c != 7) {
          ...
          s->ca.nchar = s->c;
          s->idx = find_command(s->ca.cmdchar);
          (__builtin_expect(!(s->idx >= 0), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 770, "s->idx >= 0") : (void)0);
        }
      }
    }
    ...
    while (enc_utf8 && lang && (s->c = vpeekc()) > 0
           && (s->c >= 0x100 || mb_bytelen_tab[vpeekc()] > 1)) {
      s->c = plain_vgetc();
...
static _Bool normal_get_command_count(NormalState *s)
{
  ...
  while ((s->c >= '1' && s->c <= '9') || (s->ca.count0 != 0
    ...
    ++no_zero_mapping;
    s->c = plain_vgetc();
    do { if (*p_langmap && (1) && (!p_lnr || (p_lnr && typebuf_maplen() == 0)) && !KeyStuffed && (s->c) >= 0) { if ((s->c) < 256) s->c = langmap_mapchar[s->c]; else s->c = langmap_adjust_mb(s->c); } } while (0);
    --no_zero_mapping;
    if (s->ctrl_w) {
      --no_mapping;
      --allow_keys;
...
static void normal_finish_command(NormalState *s)
{
  ...
  do_pending_operator(&s->ca, s->old_col, 0);
# 913 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
static void normal_check_interrupt(NormalState *s)
{
  ...
  if (got_int) {
    ...
    s->previous_got_int = 1;
  } else {
    s->previous_got_int = 0;
  }
}
...
static void normal_check_cursor_moved(NormalState *s)
{
  ...
  if (!finish_op && (has_cursormoved() || curwin->w_onebuf_opt.wo_cole > 0)
      && !(((last_cursormoved).lnum == (curwin->w_cursor).lnum) && ((last_cursormoved).col == (curwin->w_cursor).col) && ((last_cursormoved).coladd == (curwin->w_cursor).coladd))) {
    if (has_cursormoved()) {
...
static void normal_check_text_changed(NormalState *s)
{
  ...
  if (!finish_op && has_textchanged()
    ...
    if (last_changedtick_buf == curbuf) {
      apply_autocmds(EVENT_TEXTCHANGED, ((void*)0), ((void*)0), 0, curbuf);
    }
...
static int normal_check(VimState *state)
{
  ...
  if (skip_redraw || exmode_active) {
    ...
    if (time_fd != ((void*)0)) {
      do { if (time_fd != ((void*)0)) time_msg("first screen update", ((void*)0)); } while (0);
      do { if (time_fd != ((void*)0)) time_msg("--- NVIM STARTED ---", ((void*)0)); } while (0);
      fclose(time_fd);
      time_fd = ((void*)0);
    }
  }
...
void do_pending_operator(cmdarg_T *cap, int old_col, _Bool gui_yank)
{
  ...
  if ((finish_op
    ...
    if (VIsual_active || redo_VIsual_busy) {
      ...
      redo_VIsual_busy = 0;
# 1757 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
      if (!gui_yank) {
        VIsual_active = 0;
        setmouse();
        mouse_dragging = 0;
...
# 1821 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
# 2179 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
_Bool
do_mouse (
    oparg_T *oap,
    int c,
...
)
{
  ...
  if (which_button == 0x01) {
    if (State == 0x01) {
      ...
      return 0;
# 2347 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
# 2436 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
# 2836 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
# 2950 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
                         ...
                         char_u **string, int find_type)
{
  ...
  *string = ptr;
  ...
  (__builtin_expect(!(col >= 0), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 3069, "col >= 0") : (void)0);
  return (size_t)col;
}
...
# 3418 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
# 3596 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
_Bool
find_decl (
    char_u *ptr,
    size_t len,
...
)
{
  ...
  (__builtin_expect(!(len <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 3619, "len <= INT_MAX") : (void)0);
...
# 3716 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
static void nv_zet(cmdarg_T *cap)
{
  ...
  (__builtin_expect(!(p_siso <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 3957, "p_siso <= INT_MAX") : (void)0);
...
dozet:
  ...
  case 'W':
  {
    ...
    if (ptr == ((void*)0) && (len = find_ident_under_cursor(&ptr, 1)) == 0)
      return;
    (__builtin_expect(!(len <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 4342, "len <= INT_MAX") : (void)0);
...
# 4557 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
static void nv_ident(cmdarg_T *cap)
{
  ...
  (__builtin_expect(!(*kp != '\000'), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 4601, "*kp != NUL") : (void)0);
  _Bool kp_ex = (*kp == ':');
  ...
  case 'K':
    if (kp_ex) {
      if (cap->count0 != 0) {
        __builtin___snprintf_chk (buf, buf_size, 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "%" "ll" "d", (int64_t)(cap->count0));
      }
      ...
      _Bool isman = (strcmp((char *)(kp), (char *)("man")) == 0);
      _Bool isman_s = (strcmp((char *)(kp), (char *)("man -s")) == 0);
      if (cap->count0 != 0 && !(isman || isman_s)) {
        __builtin___snprintf_chk (buf, buf_size, 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), ".,.+%" "ll" "d", (int64_t)(cap->count0 - 1));
      }
      ...
      __builtin___strcat_chk ((char *)(buf), (char *)(" "), __builtin_object_size ((char *)(buf), 2 > 1 ? 1 : 0));
      if (cap->count0 != 0 && (isman || isman_s)) {
        __builtin___snprintf_chk (buf + strlen((char *)(buf)), buf_size - strlen((char *)(buf)), 0, __builtin_object_size (buf + strlen((char *)(buf)), 2 > 1 ? 1 : 0), "%" "ll" "d", (int64_t)cap->count0);
  ...
  default:
    ...
    if (curbuf->b_help)
      ...
      if (g_cmd)
        ...
        __builtin___snprintf_chk (buf, buf_size, 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "%" "ll" "d" "ta ", (int64_t)cap->count0);
    }
  }
  ...
  if (cmdchar == '*' || cmdchar == '#') {
    ...
    init_history();
    add_to_history(HIST_SEARCH, (char_u *)buf, 1, '\000');
...
# 5296 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
  if (vim_strchr((char_u *)
          "iI\011dD\004",
          cap->nchar) != ((void*)0)) {
    char_u *ptr;
...
static void nv_replace(cmdarg_T *cap)
{
  ...
  if (virtual_active()) {
    ...
    if (gchar_cursor() == '\000') {
      ...
      (__builtin_expect(!(cap->count1 <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 5733, "cap->count1 <= INT_MAX") : (void)0);
...
# 5776 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
      ...
      for (n = cap->count1; n > 0; --n) {
        ...
        if (cap->nchar == 5 || cap->nchar == 25) {
          int c = ins_copychar(curwin->w_cursor.lnum
                               + (cap->nchar == 25 ? -1 : 1));
          if (c != '\000') {
            (__builtin_expect(!(c >= 0 && c <= (127*2 +1)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 5831, "c >= 0 && c <= UCHAR_MAX") : (void)0);
            ptr[curwin->w_cursor.col] = (char_u)c;
          }
        } else {
          (__builtin_expect(!(cap->nchar >= 0 && cap->nchar <= (127*2 +1)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 5835, "cap->nchar >= 0 && cap->nchar <= UCHAR_MAX") : (void)0);
    ...
    if (cap->count0 > 0 && resel_VIsual_mode != '\000') {
      ...
      if (VIsual_mode == 'v') {
        if (resel_VIsual_line_count <= 1) {
          validate_virtcol();
          (__builtin_expect(!(cap->count0 >= (-2147483647 -1) && cap->count0 <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 6246, "cap->count0 >= INT_MIN && cap->count0 <= INT_MAX") : (void)0);
          curwin->w_curswant = (curwin->w_virtcol
      ...
      if (resel_VIsual_vcol == 0x7fffffff) {
        ...
        validate_virtcol();
        (__builtin_expect(!(cap->count0 >= (-2147483647 -1) && cap->count0 <= 2147483647), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 6258, "cap->count0 >= INT_MIN && cap->count0 <= INT_MAX") : (void)0);
        curwin->w_curswant = (curwin->w_virtcol
                              + resel_VIsual_vcol * (int)cap->count0 - 1);
        coladvance(curwin->w_curswant);
      } else
...
static void nv_g_cmd(cmdarg_T *cap)
{
  ...
  case 'g':
    ...
    nv_goto(cap);
    break;
# 6764 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
  case 'q':
  case 'w':
...
static void set_op_var(int optype)
{
  ...
  if (optype == 0)
    ...
    (__builtin_expect(!(opchar0 >= 0 && opchar0 <= (127*2 +1)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 6988, "opchar0 >= 0 && opchar0 <= UCHAR_MAX") : (void)0);
    opchars[0] = (char_u)opchar0;

    int opchar1 = get_extra_op_char(optype);
    (__builtin_expect(!(opchar1 >= 0 && opchar1 <= (127*2 +1)), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 6992, "opchar1 >= 0 && opchar1 <= UCHAR_MAX") : (void)0);
...
# 7009 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
# 7107 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
      cap->oap->inclusive = 1;
      word_end = 1;
      flag = 1;
    }
...
static void nv_put(cmdarg_T *cap)
{
  ...
  if (cap->oap->op_type != 0) {
    ...
    if (cap->oap->op_type == 1 && cap->cmdchar == 'p') {
      clearop(cap->oap);
      (__builtin_expect(!(cap->opcount >= 0), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 7596, "cap->opcount >= 0") : (void)0);
...
static void nv_open(cmdarg_T *cap)
{
  ...
  if (cap->oap->op_type == 1 && cap->cmdchar == 'o') {
    clearop(cap->oap);
    (__builtin_expect(!(cap->opcount >= 0), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c", 7695, "cap->opcount >= 0") : (void)0);
...
{
# 7715 "/Users/George/Documents/Programs/C/neovim/src/nvim/normal.c"
...
{
  apply_autocmds(EVENT_FOCUSGAINED, ((void*)0), ((void*)0), 0, curbuf);
}


static void nv_focuslost(cmdarg_T *cap)
{
  apply_autocmds(EVENT_FOCUSLOST, ((void*)0), ((void*)0), 0, curbuf);
}
