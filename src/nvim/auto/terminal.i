...
# 69 "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c" 2
...
# 73 "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/input.h" 1
# 74 "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c" 2
...
# 75 "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c" 2
...
# 76 "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c" 2
...
typedef struct terminal_state {
  ...
  int save_state;
  int save_rd;
  _Bool save_mapped_ctrl_c;
  _Bool close;
  _Bool got_bs;
} TerminalState;
# 97 "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c"
...
void terminal_init(void)
{
  ...
  time_watcher_init(&loop, &refresh_timer, ((void*)0));
...
# 250 "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c"
...
void terminal_enter(void)
{
  ...
  s->term = buf->terminal;
  (__builtin_expect(!(s->term && "should only be called when curbuf has a terminal"), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c", 358, "s->term && \"should only be called when curbuf has a terminal\"") : (void)0);
    ...
    int *term_attrs)
{
  ...
  (__builtin_expect(!(linenr), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c", 527, "linenr") : (void)0);
  ...
  switch (prop) {
    ...
    case VTERM_PROP_TITLE: {
      ...
      api_free_object(dict_set_value(buf->b_vars,
                                     ...
                                     ((Object) { .type = kObjectTypeString, .data.string = cstr_as_string(val->string) }),
                                     &err));
      break;
    }
...
static void refresh_terminal(Terminal *term)
{
  ...
  _Bool pending_resize = term->pending_resize;
  do { buf_T *save_curbuf = ((void*)0); win_T *save_curwin = ((void*)0); tabpage_T *save_curtab = ((void*)0); switch_to_win_for_buf(buf, &save_curwin, &save_curtab, &save_curbuf); { refresh_size(term, buf); refresh_scrollback(term, buf); refresh_screen(term, buf); redraw_buf_later(buf, 40); }; restore_win_for_buf(save_curwin, save_curtab, save_curbuf); } while (0);
...
static void adjust_topline(Terminal *term, buf_T *buf, _Bool force)
{
  ...
  for (win_T *wp = ((curtab) == curtab) ? firstwin : (curtab)->tp_firstwin; wp != ((void*)0); wp = wp->w_next) {
    if (wp->w_buffer == buf) {
      ...
      wp->w_cursor.lnum = (((wp->w_cursor.lnum)<(buf->b_ml.ml_line_count))?(wp->w_cursor.lnum):(buf->b_ml.ml_line_count));
...
# 1152 "/Users/George/Documents/Programs/C/neovim/src/nvim/terminal.c"
static char *get_config_string(char *key)
{
  Object obj;
  do { Error err; obj = dict_get_value(curbuf->b_vars, cstr_as_string(key), &err); if (obj.type == kObjectTypeNil) { obj = dict_get_value(&globvardict, cstr_as_string(key), &err); } } while (0);
