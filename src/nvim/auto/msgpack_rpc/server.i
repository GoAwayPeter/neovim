...
wcstoumax(const wchar_t * restrict __nptr,
   wchar_t ** restrict __endptr,
   int __base);
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/server.c" 2
...
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.h" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/event/socket.h" 2
...
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.h" 2
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/server.c" 2
...
# 79 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/server.c"
...
# 103 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/server.c"
int server_start(const char *endpoint)
{
  if (endpoint == ((void*)0)) {
    do_log(3, __func__, 106, 1, "Attempting to start server on NULL endpoint");
    return 1;
  }

  SocketWatcher *watcher = xmalloc(sizeof(SocketWatcher));
  socket_watcher_init(&loop, watcher, endpoint, ((void*)0));


  for (int i = 0; i < watchers.ga_len; i++) {
    if (!strcmp(watcher->addr, ((SocketWatcher **)watchers.ga_data)[i]->addr)) {
      do_log(3, __func__, 116, 1, "Already listening on %s", watcher->addr);
      socket_watcher_close(watcher, free_server);
      return 1;
    }
  }

  int result = socket_watcher_start(watcher, 32, connection_cb);
  if (result < 0) {
    do_log(3, __func__, 124, 1, "Failed to start server: %s", uv_strerror(result));
    socket_watcher_close(watcher, free_server);
    return result;
  }
...
void server_stop(char *endpoint)
{
  ...
  if (i >= watchers.ga_len) {
    do_log(3, __func__, 167, 1, "Not listening on %s", addr);
    return;
  }
...
{
  if (result) {
    do_log(3, __func__, 211, 1, "Failed to accept connection: %s", uv_strerror(result));
    return;
  }
