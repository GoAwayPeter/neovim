# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c" 2
...
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c" 2
...
wcstoumax(const wchar_t * restrict __nptr,
   wchar_t ** restrict __endptr,
   int __base);
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c" 2
...
# 24 "/Users/George/Documents/Programs/C/neovim/.deps/usr/include/msgpack/pack_define.h" 2
...
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c" 2
...
typedef void (*wstream_cb)(WStream *wstream,
                           void *data,
                           int status);
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/wstream.h" 2
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.h" 2
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c" 2
...
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c" 2
...
# 56 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/helpers.c"
...
_Bool msgpack_rpc_to_buffer(msgpack_object *obj, Buffer *arg) FUNC_ATTR_NONNULL_ALL { if (obj->type != MSGPACK_OBJECT_EXT || obj->via.ext.type != kObjectTypeBuffer) { return 0; } msgpack_object data; msgpack_unpack_return ret = msgpack_unpack(obj->via.ext.ptr, obj->via.ext.size, ((void*)0), &zone, &data); if (ret != MSGPACK_UNPACK_SUCCESS) { return 0; } *arg = data.via.u64; return 1; } void msgpack_rpc_from_buffer(Buffer o, msgpack_packer *res) FUNC_ATTR_NONNULL_ARG(2) { msgpack_packer pac; msgpack_packer_init(&pac, &sbuffer, msgpack_sbuffer_write); msgpack_pack_uint64(&pac, o); msgpack_pack_ext(res, sbuffer.size, kObjectTypeBuffer); msgpack_pack_ext_body(res, sbuffer.data, sbuffer.size); msgpack_sbuffer_clear(&sbuffer); }
_Bool msgpack_rpc_to_window(msgpack_object *obj, Window *arg) FUNC_ATTR_NONNULL_ALL { if (obj->type != MSGPACK_OBJECT_EXT || obj->via.ext.type != kObjectTypeWindow) { return 0; } msgpack_object data; msgpack_unpack_return ret = msgpack_unpack(obj->via.ext.ptr, obj->via.ext.size, ((void*)0), &zone, &data); if (ret != MSGPACK_UNPACK_SUCCESS) { return 0; } *arg = data.via.u64; return 1; } void msgpack_rpc_from_window(Window o, msgpack_packer *res) FUNC_ATTR_NONNULL_ARG(2) { msgpack_packer pac; msgpack_packer_init(&pac, &sbuffer, msgpack_sbuffer_write); msgpack_pack_uint64(&pac, o); msgpack_pack_ext(res, sbuffer.size, kObjectTypeWindow); msgpack_pack_ext_body(res, sbuffer.data, sbuffer.size); msgpack_sbuffer_clear(&sbuffer); }
_Bool msgpack_rpc_to_tabpage(msgpack_object *obj, Tabpage *arg) FUNC_ATTR_NONNULL_ALL { if (obj->type != MSGPACK_OBJECT_EXT || obj->via.ext.type != kObjectTypeTabpage) { return 0; } msgpack_object data; msgpack_unpack_return ret = msgpack_unpack(obj->via.ext.ptr, obj->via.ext.size, ((void*)0), &zone, &data); if (ret != MSGPACK_UNPACK_SUCCESS) { return 0; } *arg = data.via.u64; return 1; } void msgpack_rpc_from_tabpage(Tabpage o, msgpack_packer *res) FUNC_ATTR_NONNULL_ARG(2) { msgpack_packer pac; msgpack_packer_init(&pac, &sbuffer, msgpack_sbuffer_write); msgpack_pack_uint64(&pac, o); msgpack_pack_ext(res, sbuffer.size, kObjectTypeTabpage); msgpack_pack_ext_body(res, sbuffer.data, sbuffer.size); msgpack_sbuffer_clear(&sbuffer); }

_Bool msgpack_rpc_to_boolean(msgpack_object *obj, Boolean *arg)
...
_Bool msgpack_rpc_to_integer(msgpack_object *obj, Integer *arg)
  FUNC_ATTR_NONNULL_ALL
{
  if (obj->type == MSGPACK_OBJECT_POSITIVE_INTEGER
      && obj->via.u64 <= 9223372036854775807LL) {
...
_Bool msgpack_rpc_to_float(msgpack_object *obj, Float *arg)
  FUNC_ATTR_NONNULL_ALL
{
  *arg = obj->via.f64;
...
_Bool msgpack_rpc_to_string(msgpack_object *obj, String *arg)
  FUNC_ATTR_NONNULL_ALL
{
  if (obj->type == MSGPACK_OBJECT_BIN || obj->type == MSGPACK_OBJECT_STR) {
    if (obj->via.bin.ptr == ((void*)0)) {
      return 0;
    }
...
_Bool msgpack_rpc_to_object(msgpack_object *obj, Object *arg)
  FUNC_ATTR_NONNULL_ALL
{
  switch (obj->type) {
...
_Bool msgpack_rpc_to_array(msgpack_object *obj, Array *arg)
  FUNC_ATTR_NONNULL_ALL
{
...
_Bool msgpack_rpc_to_dictionary(msgpack_object *obj, Dictionary *arg)
  FUNC_ATTR_NONNULL_ALL
{
...
Object msgpack_rpc_handle_missing_method(uint64_t channel_id,
                                         ...
                                         Error *error)
{
  __builtin___snprintf_chk (error->msg, sizeof(error->msg), 0, __builtin_object_size (error->msg, 2 > 1 ? 1 : 0), "Invalid method name");
  error->set = 1;
...
Object msgpack_rpc_handle_invalid_arguments(uint64_t channel_id,
                                            ...
                                            Error *error)
{
  __builtin___snprintf_chk (error->msg, sizeof(error->msg), 0, __builtin_object_size (error->msg, 2 > 1 ? 1 : 0), "Invalid method arguments");
  error->set = 1;
  return ((Object) {.type = kObjectTypeNil});
}
                          ...
                          Error *err)
{
  ...
  *response_id = 18446744073709551615ULL;

  if (req->type != MSGPACK_OBJECT_ARRAY) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Message is not an array"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return;
  }

  if (req->via.array.size == 0) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Message is empty"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return;
  }

  if (req->via.array.ptr[0].type != MSGPACK_OBJECT_POSITIVE_INTEGER) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Message type must be an integer"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return;
  }

  uint64_t type = req->via.array.ptr[0].via.u64;
  if (type != kMessageTypeRequest && type != kMessageTypeNotification) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Unknown message type"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return;
  }

  if ((type == kMessageTypeRequest && req->via.array.size != 4) ||
      (type == kMessageTypeNotification && req->via.array.size != 3)) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Request array size should be 4 (request) " "or 3 (notification)"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
  ...
  if (type == kMessageTypeRequest) {
    ...
    if (!id_obj) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("ID must be a positive integer"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
      return;
    }
  ...
  if (!msgpack_rpc_method(req)) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Method must be a string"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return;
  }

  if (!msgpack_rpc_args(req)) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Parameters must be an array"))); (err)->set = 1; (err)->type = kErrorTypeValidation; } while (0);
    return;
  }
}
