# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
wcstoumax(const wchar_t * restrict __nptr,
   wchar_t ** restrict __endptr,
   int __base);
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/api/vim.h" 1
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.h" 1
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.h" 2
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 13 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/rstream.h" 1
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/wstream.h" 1
# 16 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/job.h" 1
# 18 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 20 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 22 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 6 "/Users/George/Documents/Programs/C/neovim/src/nvim/os_unix.h" 2
# 24 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/message.h" 1
# 25 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
...
# 26 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/misc1.h" 1
# 28 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c" 2
# 37 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c"
typedef struct {
  uint64_t request_id;
...
typedef struct {
  ...
  struct { size_t size, capacity; ChannelCallFrame * *items; } call_stack;
  struct { size_t size, capacity; WBuffer * *items; } delayed_notifications;
} Channel;
...
static Map_uint64_t_ptr_t *channels = ((void*)0);
...
void channel_teardown(void)
{
  ...
  { khint_t __i; for (__i = (khint_t)(0); __i != ((channels->table)->n_buckets); ++__i) { if (!(!(((channels->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (channel) = ((channels->table)->vals[__i]); { close_channel(channel); }; } };
...
# 167 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c"
_Bool channel_send_event(uint64_t id, char *name, Array args)
{
  Channel *channel = ((void*)0);

  if (id && (!(channel = map_uint64_t_ptr_t_get(channels, id))
            || channel->closed)) {
    api_free_array(args);
    return 0;
  }
  ...
  if (channel) {
    if (channel->pending_requests) {
      ...
      do { if ((channel->delayed_notifications).size == (channel->delayed_notifications).capacity) { (channel->delayed_notifications).capacity = (channel->delayed_notifications).capacity? (channel->delayed_notifications).capacity<<1 : 8; (channel->delayed_notifications).items = (WBuffer **)xrealloc((channel->delayed_notifications).items, sizeof(WBuffer *) * (channel->delayed_notifications).capacity); } (channel->delayed_notifications).items[(channel->delayed_notifications).size++] = (buffer); } while (0);
    } else {
...
# 201 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.c"
                         ...
                         Error *err)
{
  ...
  if (!(channel = map_uint64_t_ptr_t_get(channels, id)) || channel->closed) {
    do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Invalid channel \"%" "ll" "u" "\"")), id); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
    api_free_array(args);
  ...
  do { if ((channel->call_stack).size == (channel->call_stack).capacity) { (channel->call_stack).capacity = (channel->call_stack).capacity? (channel->call_stack).capacity<<1 : 8; (channel->call_stack).items = (ChannelCallFrame **)xrealloc((channel->call_stack).items, sizeof(ChannelCallFrame *) * (channel->call_stack).capacity); } (channel->call_stack).items[(channel->call_stack).size++] = (&frame); } while (0);
  channel->pending_requests++;
  do { int remaining = -1; uint64_t before = (remaining > 0) ? os_hrtime() : 0; while (!(frame.returned)) { event_poll(remaining); if (remaining == 0) { break; } else if (remaining > 0) { uint64_t now = os_hrtime(); remaining -= (int) ((now - before) / 1000000); before = now; if (remaining <= 0) { break; } } } } while (0);
  (void)((channel->call_stack).items[--(channel->call_stack).size]);
  channel->pending_requests--;

  if (frame.errored) {
    if (frame.result.type == kObjectTypeString) {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), "%s", frame.result.data.string.data); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
      ...
      if (array.size == 2 && array.items[0].type == kObjectTypeInteger
        ...
        do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), "%s", "unknown error"); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
      }
    } else {
      do { __builtin___snprintf_chk ((err)->msg, sizeof((err)->msg), 0, __builtin_object_size ((err)->msg, 2 > 1 ? 1 : 0), "%s", "unknown error"); (err)->set = 1; (err)->type = kErrorTypeException; } while (0);
    }
...
void channel_subscribe(uint64_t id, char *event)
{
  ...
  map_cstr_t_ptr_t_put(channel->subscribed_events, event_string, event_string);
}
...
static void channel_from_stdio(void)
{
  ...
  channel->data.streams.uv = ((void*)0);
}
...
static void job_err(RStream *rstream, RBuffer *rbuf, void *data, _Bool eof)
{
  while (rbuffer_size(rbuf)) {
    ...
    buf[read] = '\000';
    do_log(3, __func__, 344, 1, "Channel %" "ll" "u" " stderr: %s", ((Channel *)job_data(data))->id, buf);
  ...
  while ((result = msgpack_unpacker_next(channel->unpacker, &unpacked)) ==
    ...
    if (is_response) {
      if (is_valid_rpc_response(&unpacked.data, channel)) {
        ...
        char buf[256];
        __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "Channel %" "ll" "u" " returned a response that doesn't have " "a matching request id. Ensure the client is properly " "synchronized", channel->id);
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  if (error.set) {
    ...
    if (channel_write(channel,
                      serialize_response(channel->id,
                                         ...
                                         &out_buffer))) {
      char buf[256];
      __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "Channel %" "ll" "u" " sent an invalid message, closed.", channel->id);
  ...
  _Bool defer = (!((channel->call_stack).size) && handler.defer);
...
static void on_request_event(Event event)
{
  ...
  if (request_id != 18446744073709551615ULL) {
...
static _Bool channel_write(Channel *channel, WBuffer *buffer)
{
  ...
  if (!success) {
    ...
    char buf[256];
    __builtin___snprintf_chk (buf, sizeof(buf), 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "Before returning from a RPC call, channel %" "ll" "u" " was " "closed due to a failed write", channel->id);
...
{
  Error e = { .set = 0 };
  do { __builtin___snprintf_chk ((&e)->msg, sizeof((&e)->msg), 0, __builtin_object_size ((&e)->msg, 2 > 1 ? 1 : 0), "%s", err); (&e)->set = 1; (&e)->type = kErrorTypeException; } while (0);
  channel_write(channel, serialize_response(channel->id,
                                            id,
                                            &e,
                                            ((Object) {.type = kObjectTypeNil}),
...
{
  struct { size_t size, capacity; Channel * *items; } subscribed;
  ((subscribed).size = (subscribed).capacity = 0, (subscribed).items = 0);
  Channel *channel;

  { khint_t __i; for (__i = (khint_t)(0); __i != ((channels->table)->n_buckets); ++__i) { if (!(!(((channels->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (channel) = ((channels->table)->vals[__i]); { if (map_cstr_t_ptr_t_has(channel->subscribed_events, name)) { do { if ((subscribed).size == (subscribed).capacity) { (subscribed).capacity = (subscribed).capacity? (subscribed).capacity<<1 : 8; (subscribed).items = (Channel **)xrealloc((subscribed).items, sizeof(Channel *) * (subscribed).capacity); } (subscribed).items[(subscribed).size++] = (channel); } while (0); } }; } };
  ...
  for (size_t i = 0; i < ((subscribed).size); i++) {
    Channel *channel = ((subscribed).items[(i)]);
    if (channel->pending_requests) {
      do { if ((channel->delayed_notifications).size == (channel->delayed_notifications).capacity) { (channel->delayed_notifications).capacity = (channel->delayed_notifications).capacity? (channel->delayed_notifications).capacity<<1 : 8; (channel->delayed_notifications).items = (WBuffer **)xrealloc((channel->delayed_notifications).items, sizeof(WBuffer *) * (channel->delayed_notifications).capacity); } (channel->delayed_notifications).items[(channel->delayed_notifications).size++] = (buffer); } while (0);
    } else {
  ...
  xfree((subscribed).items);
}

static void unsubscribe(Channel *channel, char *event)
{
  char *event_string = map_cstr_t_ptr_t_get(event_strings, event);
  map_cstr_t_ptr_t_del(channel->subscribed_events, event_string);

  { khint_t __i; for (__i = (khint_t)(0); __i != ((channels->table)->n_buckets); ++__i) { if (!(!(((channels->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (channel) = ((channels->table)->vals[__i]); { if (map_cstr_t_ptr_t_has(channel->subscribed_events, event_string)) { return; } }; } };
...
static void close_channel(Channel *channel)
{
  ...
  if (channel->is_job) {
    ...
    if (handle) {
      ...
      event_push((Event) { .handler = on_stdio_close, .data = channel }, 0);
    }
  }
...
static void free_channel(Channel *channel)
{
  ...
  map_uint64_t_ptr_t_del(channels, channel->id);
  msgpack_unpacker_free(channel->unpacker);


  char *event_string;
  { khint_t __i; for (__i = (khint_t)(0); __i != ((channel->subscribed_events->table)->n_buckets); ++__i) { if (!(!(((channel->subscribed_events->table)->flags[(__i)>>4]>>(((__i)&0xfU)<<1))&3))) continue; (event_string) = ((channel->subscribed_events->table)->vals[__i]); { unsubscribe(channel, event_string); }; } };



  map_cstr_t_ptr_t_free(channel->subscribed_events);
  xfree((channel->call_stack).items);
  xfree((channel->delayed_notifications).items);
  xfree(channel);
}
...
static Channel *register_channel(void)
{
  ...
  rv->refcount = 1;
  rv->closed = 0;
  rv->unpacker = msgpack_unpacker_new((64*1024));
  rv->id = next_id++;
  rv->pending_requests = 0;
  rv->subscribed_events = map_cstr_t_ptr_t_new();
  rv->next_request_id = 1;
  ((rv->call_stack).size = (rv->call_stack).capacity = 0, (rv->call_stack).items = 0);
  ((rv->delayed_notifications).size = (rv->delayed_notifications).capacity = 0, (rv->delayed_notifications).items = 0);
  map_uint64_t_ptr_t_put(channels, rv->id, rv);
  return rv;
}
...
static _Bool is_valid_rpc_response(msgpack_object *obj, Channel *channel)
{
  ...
  return ((channel->call_stack).size) && response_id
    == ((channel->call_stack).items[(((channel->call_stack).size) - 1)])->request_id;
}

static void complete_call(msgpack_object *obj, Channel *channel)
{
  ChannelCallFrame *frame = ((channel->call_stack).items[(((channel->call_stack).size) - 1)]);
...
{
  do_log(3, __func__, 740, 1, "msgpack-rpc: %s", msg);
  for (size_t i = 0; i < ((channel->call_stack).size); i++) {
    ChannelCallFrame *frame = ((channel->call_stack).items[(i)]);
    frame->returned = 1;
    frame->errored = 1;
...
{
  for (size_t i = 0; i < ((channel->delayed_notifications).size); i++) {
    WBuffer *buffer = ((channel->delayed_notifications).items[(i)]);
    channel_write(channel, buffer);
  }

  ((channel->delayed_notifications).size) = 0;
}
