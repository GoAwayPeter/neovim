# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
# 2 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
typedef int wchar_t;
# 3 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
# 4 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
# 5 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
# 130 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/os_defs.h"
...
# 131 "/Users/George/Documents/Programs/C/neovim/src/nvim/os/os_defs.h" 2
...
# 7 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
# 8 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
# 9 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
# 74 "/usr/include/sys/uio.h" 3 4
# 1 "/usr/include/sys/_types/_size_t.h" 1 3 4
# 75 "/usr/include/sys/uio.h" 2 3 4
...
# 10 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.h" 1
# 11 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/channel.h" 1
# 12 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/msgpack_rpc/remote_ui.c" 2
...
void remote_ui_init(void)
{
  ...
  MsgpackRpcRequestHandler handler = {.fn = remote_ui_attach, .defer = 0};
                               ...
                               Array args, Error *error)
{
  if (map_uint64_t_ptr_t_has(connected_uis, channel_id)) {
    do { __builtin___snprintf_chk ((error)->msg, sizeof((error)->msg), 0, __builtin_object_size ((error)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("UI already attached for channel"))); (error)->set = 1; (error)->type = kErrorTypeException; } while (0);
  ...
  if (args.size != 3 || args.items[0].type != kObjectTypeInteger
    ...
    do { __builtin___snprintf_chk ((error)->msg, sizeof((error)->msg), 0, __builtin_object_size ((error)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Invalid arguments. Expected: " "(uint width > 0, uint height > 0, bool enable_rgb)"))); (error)->set = 1; (error)->type = kErrorTypeValidation; } while (0);
...
{
  if (!map_uint64_t_ptr_t_has(connected_uis, channel_id)) {
    do { __builtin___snprintf_chk ((error)->msg, sizeof((error)->msg), 0, __builtin_object_size ((error)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("UI is not attached for channel"))); (error)->set = 1; (error)->type = kErrorTypeException; } while (0);
  }
                                   ...
                                   Array args, Error *error)
{
  ...
  if (args.size != 2 || args.items[0].type != kObjectTypeInteger
      || args.items[1].type != kObjectTypeInteger
      || args.items[0].data.integer <= 0 || args.items[1].data.integer <= 0) {
    do { __builtin___snprintf_chk ((error)->msg, sizeof((error)->msg), 0, __builtin_object_size ((error)->msg, 2 > 1 ? 1 : 0), libintl_gettext((char *)("Invalid arguments. Expected: " "(uint width > 0, uint height > 0)"))); (error)->set = 1; (error)->type = kErrorTypeValidation; } while (0);
...
static void push_call(UI *ui, char *name, Array args)
{
  ...
  if (!((call).size) || strcmp(((call).items[(0)]).data.string.data, name)) {
    ...
    do { if ((data->buffer).size == (data->buffer).capacity) { (data->buffer).capacity = (data->buffer).capacity? (data->buffer).capacity<<1 : 8; (data->buffer).items = (Object*)xrealloc((data->buffer).items, sizeof(Object) * (data->buffer).capacity); } (data->buffer).items[(data->buffer).size++] = (((Object) { .type = kObjectTypeArray, .data.array = call })); } while (0);
    do { if ((call).size == (call).capacity) { (call).capacity = (call).capacity? (call).capacity<<1 : 8; (call).items = (Object*)xrealloc((call).items, sizeof(Object) * (call).capacity); } (call).items[(call).size++] = (((Object) { .type = kObjectTypeString, .data.string = cstr_to_string(name) })); } while (0);
  }

  do { if ((call).size == (call).capacity) { (call).capacity = (call).capacity? (call).capacity<<1 : 8; (call).items = (Object*)xrealloc((call).items, sizeof(Object) * (call).capacity); } (call).items[(call).size++] = (((Object) { .type = kObjectTypeArray, .data.array = args })); } while (0);
...
static void remote_ui_resize(UI *ui, int width, int height)
{
  ...
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = width })); } while (0);
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = height })); } while (0);
...
{
  Array args = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = row })); } while (0);
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = col })); } while (0);
...
{
  Array args = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = top })); } while (0);
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = bot })); } while (0);
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = left })); } while (0);
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = right })); } while (0);
...
{
  Array args = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = count })); } while (0);
...
static void remote_ui_highlight_set(UI *ui, HlAttrs attrs)
{
  ...
  if (attrs.bold) {
    do { if ((hl).size == (hl).capacity) { (hl).capacity = (hl).capacity? (hl).capacity<<1 : 8; (hl).items = (KeyValuePair*)xrealloc((hl).items, sizeof(KeyValuePair) * (hl).capacity); } (hl).items[(hl).size++] = (((KeyValuePair) {.key = cstr_to_string("bold"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 })})); } while (0);
  }

  if (attrs.underline) {
    do { if ((hl).size == (hl).capacity) { (hl).capacity = (hl).capacity? (hl).capacity<<1 : 8; (hl).items = (KeyValuePair*)xrealloc((hl).items, sizeof(KeyValuePair) * (hl).capacity); } (hl).items[(hl).size++] = (((KeyValuePair) {.key = cstr_to_string("underline"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 })})); } while (0);
  }

  if (attrs.undercurl) {
    do { if ((hl).size == (hl).capacity) { (hl).capacity = (hl).capacity? (hl).capacity<<1 : 8; (hl).items = (KeyValuePair*)xrealloc((hl).items, sizeof(KeyValuePair) * (hl).capacity); } (hl).items[(hl).size++] = (((KeyValuePair) {.key = cstr_to_string("undercurl"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 })})); } while (0);
  }

  if (attrs.italic) {
    do { if ((hl).size == (hl).capacity) { (hl).capacity = (hl).capacity? (hl).capacity<<1 : 8; (hl).items = (KeyValuePair*)xrealloc((hl).items, sizeof(KeyValuePair) * (hl).capacity); } (hl).items[(hl).size++] = (((KeyValuePair) {.key = cstr_to_string("italic"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 })})); } while (0);
  }

  if (attrs.reverse) {
    do { if ((hl).size == (hl).capacity) { (hl).capacity = (hl).capacity? (hl).capacity<<1 : 8; (hl).items = (KeyValuePair*)xrealloc((hl).items, sizeof(KeyValuePair) * (hl).capacity); } (hl).items[(hl).size++] = (((KeyValuePair) {.key = cstr_to_string("reverse"), .value = ((Object) { .type = kObjectTypeBoolean, .data.boolean = 1 })})); } while (0);
  }

  if (attrs.foreground != -1) {
    do { if ((hl).size == (hl).capacity) { (hl).capacity = (hl).capacity? (hl).capacity<<1 : 8; (hl).items = (KeyValuePair*)xrealloc((hl).items, sizeof(KeyValuePair) * (hl).capacity); } (hl).items[(hl).size++] = (((KeyValuePair) {.key = cstr_to_string("foreground"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = attrs.foreground })})); } while (0);
  }

  if (attrs.background != -1) {
    do { if ((hl).size == (hl).capacity) { (hl).capacity = (hl).capacity? (hl).capacity<<1 : 8; (hl).items = (KeyValuePair*)xrealloc((hl).items, sizeof(KeyValuePair) * (hl).capacity); } (hl).items[(hl).size++] = (((KeyValuePair) {.key = cstr_to_string("background"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = attrs.background })})); } while (0);
  }

  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeDictionary, .data.dictionary = hl })); } while (0);
...
static void remote_ui_put(UI *ui, uint8_t *data, size_t size)
{
  ...
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeString, .data.string = str })); } while (0);
...
{
  Array args = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = fg })); } while (0);
...
{
  Array args = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeInteger, .data.integer = bg })); } while (0);
...
{
  Array args = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeString, .data.string = cstr_to_string(title) })); } while (0);
...
{
  Array args = {.size = 0, .capacity = 0, .items = ((void*)0)};
  do { if ((args).size == (args).capacity) { (args).capacity = (args).capacity? (args).capacity<<1 : 8; (args).items = (Object*)xrealloc((args).items, sizeof(Object) * (args).capacity); } (args).items[(args).size++] = (((Object) { .type = kObjectTypeString, .data.string = cstr_to_string(icon) })); } while (0);
