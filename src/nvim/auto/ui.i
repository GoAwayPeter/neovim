...
{
  int new_col = col - 1;
  (__builtin_expect(!(new_col >= 0), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/ui.c", 450, "new_col >= 0") : (void)0);
  ui_cursor_goto(row, new_col);
}
...
{
  int new_col = col + 1;
  (__builtin_expect(!(new_col < width), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/ui.c", 457, "new_col < width") : (void)0);
  ui_cursor_goto(row, new_col);
}
