# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 321 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
# 14 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c"
...
# 15 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
...
wcstoumax(const wchar_t * restrict __nptr,
   wchar_t ** restrict __endptr,
   int __base);
# 16 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
...
# 17 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
...
# 19 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
...
# 20 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2

# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/charset.h" 1
# 22 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
...
# 23 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
...
# 24 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/ex_docmd.h" 1
# 25 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/getchar.h" 1
# 26 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
...
# 27 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/message.h" 1
# 28 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/misc1.h" 1
# 29 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2



# 1 "/Users/George/Documents/Programs/C/neovim/src/nvim/strings.h" 1
# 33 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c" 2
# 46 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c"
...
)
{
  ...
  if (strncmp((char *)(arg), (char *)("icon="), (size_t)(5)) == 0) {
    ...
    while (*arg != '\000' && *arg != ' ') {
      ...
      (arg += has_mbyte ? (*mb_ptr2len)((char_u *)arg) : 1);
    }
    if (*arg != '\000') {
      *arg++ = '\000';
      arg = skipwhite(arg);
  ...
  menu_path = arg;
  if (*menu_path == '.') {
    emsg2((char_u *)(libintl_gettext((char *)(e_invarg2))), (char_u *)(menu_path));
    goto theend;
  }
  ...
  if (*map_to == '\000' && !unmenu && enable == 2) {
    show_menus(menu_path, modes);
    goto theend;
  } else if (*map_to != '\000' && (unmenu || enable != 2)) {
  ...
  if (enable != 2) {
    ...
    if (menu_is_popup(menu_path)) {
      for (i = 0; i < 6; ++i)
        if (modes & (1 << i)) {
          ...
          menu_nable_recurse(root_menu, p, ((1 << 6) - 1), enable);
          xfree(p);
        }
    }
    ...
    if (menu_is_popup(menu_path)) {
      for (i = 0; i < 6; ++i)
        if (modes & (1 << i)) {
          p = popup_mode_name(menu_path, i);
          remove_menu(&root_menu, p, ((1 << 6) - 1), 1);
          xfree(p);
        }
    }
    ...
    if (strcasecmp((char *)(map_to), (char *)("<nop>")) == 0) {
      ...
      map_to = replace_termcodes(map_to, &map_buf, 0, 1, special);
    menuarg.modes = modes;
    ...
    for (i = 0; i < 7; ++i) {
      if (modes & (1 << i)) {
        ...
        if (c != 0) {
          ...
          menu->strings[i][0] = c;
          if (d == 0)
            __builtin___strcpy_chk ((char *)(menu->strings[i] + 1), (char *)(call_data), __builtin_object_size ((char *)(menu->strings[i] + 1), 2 > 1 ? 1 : 0));
          else {
            menu->strings[i][1] = d;
            __builtin___strcpy_chk ((char *)(menu->strings[i] + 2), (char *)(call_data), __builtin_object_size ((char *)(menu->strings[i] + 2), 2 > 1 ? 1 : 0));
          }
          if (c == 3) {
...
static int menu_nable_recurse(vimmenu_T *menu, char_u *name, int modes, int enable)
{
  ...
  if (*name != '\000' && *name != '*' && menu == ((void*)0)) {
    emsg2((char_u *)(libintl_gettext((char *)(e_nomenu))), (char_u *)(name));
    return 0;
  }
...
# 584 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c"
      ...
      menu->modes &= ~modes;
      if (modes & (1 << 6))
        free_menu_string(menu, 6);
      if ((menu->modes & ((1 << 6) - 1)) == 0)
        free_menu(menup);
      else
        menup = &menu->next;
    } else
  ...
  if (menu != ((void*)0) && menu->children == ((void*)0)) {
    for (bit = 0; bit < 7; bit++)
      if ((menu->modes & modes & (1 << bit)) != 0) {
        ...
        if (menu->noremap[bit] == -1)
          msg_putchar('*');
        else if (menu->noremap[bit] == -2)
          msg_putchar('&');
        else
          msg_putchar(' ');
        if (menu->silent[bit])
        ...
        if (*menu->strings[bit] == '\000')
          ...
          msg_outtrans_special(menu->strings[bit], 0);
      }
  } else {
    if (menu == ((void*)0)) {
      menu = root_menu;
...
char_u *get_menu_names(expand_T *xp, int idx)
{
  ...
  if (menu->modes & expand_modes) {
    if (menu->children != ((void*)0)) {
      ...
      __builtin___strcat_chk ((char *)(tbuffer), (char *)("\001"), __builtin_object_size ((char *)(tbuffer), 2 > 1 ? 1 : 0));
      str = tbuffer;
    } else {
      if (should_advance)
        str = menu->en_dname;
...
char_u *menu_name_skip(char_u *name)
{
  ...
  for (p = name; *p && *p != '.'; (p += has_mbyte ? (*mb_ptr2len)((char_u *)p) : 1)) {
    if (*p == '\\' || *p == 22) {
...
# 1084 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c"
static int
get_menu_cmd_modes (
    char_u *cmd,
    int forceit,
...
static char_u *popup_mode_name(char_u *name, int idx)
{
  ...
  (__builtin_expect(!(len >= 4), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c", 1150, "len >= 4") : (void)0);
...
# 1171 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c"
  ...
  FUNC_ATTR_NONNULL_ARG(1)
{
  ...
  if (p != ((void*)0)) {
    ...
    (__builtin_expect(!(p >= str), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c", 1183, "p >= str") : (void)0);
...
{
  return (name[0] == ']') || (menu_is_popup(name) && name[5] != '\000');
}
...
void ex_emenu(exarg_T *eap)
{
  ...
  xfree(saved_name);
  if (menu == ((void*)0)) {
    emsg2((char_u *)(libintl_gettext((char *)("E334: Menu not found: %s"))), (char_u *)(eap->arg));
    return;
  }
  ...
  if (idx != -1 && menu->strings[idx] != ((void*)0)) {
    ...
    emsg2((char_u *)(libintl_gettext((char *)("E335: Menu not defined for %s mode"))), (char_u *)(mode));
}
# 1426 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c"
typedef struct {
  char_u *from;
  char_u *from_noamp;
  char_u *to;
...
# 1445 "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c"
  ...
  if (strncmp((char *)(arg), (char *)("clear"), (size_t)(5)) == 0 && ends_excmd(*skipwhite(arg + 5))) {
    ...
    *arg = '\000';
    ...
    if (arg == to)
      ...
      (__builtin_expect(!(arg >= to), 0) ? __assert_rtn(__func__, "/Users/George/Documents/Programs/C/neovim/src/nvim/menu.c", 1473, "arg >= to") : (void)0);
...
static char_u *menutrans_lookup(char_u *name, int len)
{
  ...
  for (int i = 0; i < menutrans_ga.ga_len; i++) {
    if (strncmp((char *)(name), (char *)(tp[i].from), (size_t)(len)) == 0 && tp[i].from[len] == '\000') {
      return tp[i].to;
    }
  }
  ...
  name[len] = c;
  for (int i = 0; i < menutrans_ga.ga_len; i++) {
    if (strcmp((char *)(dname), (char *)(tp[i].from_noamp)) == 0) {
      xfree(dname);
      return tp[i].to;
    }
  }
